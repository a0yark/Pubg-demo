...
public:
	...
	static class UMovieSceneSignedObject* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class INodeAndChannelMappings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneEntitySystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneSequenceTickManagerClient* GetDefaultObj()	 // 0x0
	{
...
public:
	struct FMovieSceneObjectBindingID FindBindingByTag(class FName InBindingName) const	 // 0x64c957c;
	const TArray<struct FMovieSceneObjectBindingID> FindBindingsByTag(class FName InBindingName) const	 // 0x64c9660;
	struct FMovieSceneTimecodeSource GetEarliestTimecodeSource() const	 // 0x64c9944;
...
public:
	...
	static class UMovieSceneSequence* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneEntityInstantiatorSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneRootInstantiatorSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetBlendType(EMovieSceneBlendType InBlendType)	 // 0x64caf50;
	void SetColorTint(const struct FColor& InColorTint)	 // 0x64cb014;
	void SetCompletionMode(EMovieSceneCompletionMode InCompletionMode)	 // 0x64cb078;
	void SetIsActive(bool bInIsActive)	 // 0x64cb488;
	void SetIsLocked(bool bInIsLocked)	 // 0x64cb548;
	void SetOverlapPriority(int32 NewPriority)	 // 0x64cb618;
	void SetPostRollFrames(int32 InPostRollFrames)	 // 0x64cb894;
	void SetPreRollFrames(int32 InPreRollFrames)	 // 0x64cb95c;
	void SetRowIndex(int32 NewRowIndex)	 // 0x64cba24;

	struct FOptionalMovieSceneBlendType GetBlendType() const	 // 0x64c9738;
	struct FColor GetColorTint() const	 // 0x64c986c;
	EMovieSceneCompletionMode GetCompletionMode() const	 // 0x64c9888;
	int32 GetOverlapPriority() const	 // 0x64c9af8;
	int32 GetPostRollFrames() const	 // 0x64c9b28;
	int32 GetPreRollFrames() const	 // 0x55f2bfc;
	int32 GetRowIndex() const	 // 0x64c9b40;
	bool IsActive() const	 // 0x64c9ca8;
	bool IsLocked() const	 // 0x64c9cc4;
...
public:
	...
	static class UMovieSceneSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneNodeGroup* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneHookSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneEvaluationHookSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneEntitySystemLinker* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneCompiledDataManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneNameableTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieScenePlaybackClient* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneBoolSection* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetSequence(class UMovieSceneSequence* Sequence)	 // 0x64d414c;

	class UMovieSceneSequence* GetSequence() const	 // 0x64d4134;
...
public:
	...
	static class UMovieSceneSubSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneBlenderSystemSupport* GetDefaultObj()	 // 0x0
	{
...
public:
	void ChangePlaybackDirection()	 // 0x64c9568;
	TArray<class UObject*> GetBoundObjects(const struct FMovieSceneObjectBindingID& ObjectBinding)	 // 0x64c9754;
	bool GetDisableCameraCuts()	 // 0x64c98d4;
	TArray<struct FMovieSceneObjectBindingID> GetObjectBindings(class UObject* InObject)	 // 0x64c99d8;
	void GoToEndAndStop()	 // 0x64c9c94;
	void JumpToFrame(const struct FFrameTime& NewPosition)	 // 0x64c9d34;
	bool JumpToMarkedFrame(const class FString& InLabel)	 // 0x64c9e1c;
	void JumpToSeconds(float TimeInSeconds)	 // 0x64c9f0c;
	void Pause()	 // 0x64ca410;
	void Play()	 // 0x64ca424;
	void PlayLooping(int32 NumLoops)	 // 0x64ca438;
	void PlayReverse()	 // 0x64ca4f8;
	void PlayTo(const struct FMovieSceneSequencePlaybackParams& PlaybackParams, const struct FMovieSceneSequencePlayToParams& PlayToParams)	 // 0x64ca50c;
	void PlayToFrame(const struct FFrameTime& NewPosition)	 // 0x64ca68c;
	bool PlayToMarkedFrame(const class FString& InLabel)	 // 0x64ca774;
	void PlayToSeconds(float TimeInSeconds)	 // 0x64ca864;
	void RemoveWeight()	 // 0x64cac28;
	void RestoreState()	 // 0x64cac60;
	void RPC_ExplicitServerUpdateEvent(EUpdatePositionMethod Method, const struct FFrameTime& RelevantTime)	 // 0x64ca950;
	void RPC_OnFinishPlaybackEvent(const struct FFrameTime& StoppedTime)	 // 0x64caa98;
	void RPC_OnStopEvent(const struct FFrameTime& StoppedTime)	 // 0x64cab60;
	void Scrub()	 // 0x64cac78;
	void ScrubToFrame(const struct FFrameTime& NewPosition)	 // 0x64cac8c;
	bool ScrubToMarkedFrame(const class FString& InLabel)	 // 0x64cad74;
	void ScrubToSeconds(float TimeInSeconds)	 // 0x64cae64;
	void SetDisableCameraCuts(bool bInDisableCameraCuts)	 // 0x64cb134;
	void SetFrameRange(int32 StartFrame, int32 Duration, float SubFrames)	 // 0x64cb204;
	void SetFrameRate(const struct FFrameRate& FrameRate)	 // 0x64cb3bc;
	void SetPlaybackPosition(const struct FMovieSceneSequencePlaybackParams& PlaybackParams)	 // 0x64cb798;
	void SetPlayRate(float PlayRate)	 // 0x64cb6d4;
	void SetTimeRange(float StartTime_0, float Duration)	 // 0x64cbae0;
	void SetWeight(double InWeight)	 // 0x64cbc20;
	void Stop()	 // 0x64cbcec;
	void StopAtCurrentTime()	 // 0x64cbd00;

	struct FQualifiedFrameTime GetCurrentTime() const	 // 0x64c989c;
	struct FQualifiedFrameTime GetDuration() const	 // 0x64c98f0;
	struct FQualifiedFrameTime GetEndTime() const	 // 0x64c997c;
	int32 GetFrameDuration() const	 // 0x64c99a8;
	struct FFrameRate GetFrameRate() const	 // 0x64c99c0;
	float GetPlayRate() const	 // 0x64c9b10;
	class UMovieSceneSequence* GetSequence() const	 // 0x64c9b58;
	class FString GetSequenceName(bool bAddClientInfo) const	 // 0x64c9b70;
	struct FQualifiedFrameTime GetStartTime() const	 // 0x64c9c58;
	bool IsPaused() const	 // 0x64c9ce0;
	bool IsPlaying() const	 // 0x64c9cfc;
	bool IsReversed() const	 // 0x64c9d18;
...
public:
	...
	static class UMovieSceneSequencePlayer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneSubTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneChannelOverrideProvider* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneDeterminismSource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneEvaluationHook* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneSequencePlayerObserver* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneBindingOwnerInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneCachedTrack* GetDefaultObj()	 // 0x0
	{
...
{
public:
	float OnEvaluate(float Interp) const	 // 0xae1e64;
...
public:
	...
	static class IMovieSceneEasingFunction* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneKeyProxy* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneChannelOverrideContainer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneSectionChannelOverrideRegistry* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneTrackTemplateProducer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneCompiledData* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneEntityProvider* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneBlenderSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneGenericBoundObjectInstantiator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneBoundSceneComponentInstantiator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneValueDecomposer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneEvalTimeSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieScenePreAnimatedStateSystemInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneCachePreAnimatedStateSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneRestorePreAnimatedStateSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneSpawnablesSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneTrackInstance* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneTrackInstanceInstantiator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneTrackInstanceSystem* GetDefaultObj()	 // 0x0
	{
...
{
public:
	struct FFrameTime OnRequestCurrentTime(const struct FQualifiedFrameTime& InCurrentTime, float InPlayRate)	 // 0x64c9ff8;
	void OnStartPlaying(const struct FQualifiedFrameTime& InStartTime)	 // 0x64ca194;
	void OnStopPlaying(const struct FQualifiedFrameTime& InStopTime)	 // 0x64ca230;
	void OnTick(float DeltaSeconds, float InPlayRate)	 // 0x64ca2cc;
...
public:
	...
	static class IMovieSceneCustomClockSource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneBuiltInEasingFunction* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneEasingExternalCurve* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneNodeGroupCollection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieScene* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneBindingOverrides* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneFolder* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneSequenceTickManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneSpawnSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneSequence* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneSubTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneSubSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneEvalHookTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestMovieSceneEvalHookSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneSpawnTrack* GetDefaultObj()	 // 0x0
	{

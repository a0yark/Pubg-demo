...
public:
	...
	static class ULiveLinkBasicFrameInterpolationProcessor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkTransformAxisSwitchPreProcessor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkMessageBusSourceFactory* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkAnimationFrameInterpolationProcessor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkAnimationVirtualSubject* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static int32 ChildCount(struct FLiveLinkTransform& LiveLinkTransform)	 // 0x503646c;
	static void ComponentSpaceTransform(struct FLiveLinkTransform& LiveLinkTransform, struct FTransform* Transform)	 // 0x5036598;
	static bool EvaluateLiveLinkFrame(const struct FLiveLinkSubjectRepresentation& SubjectRepresentation, struct FLiveLinkBaseBlueprintData* OutBlueprintData)	 // 0x50368f4;
	static bool EvaluateLiveLinkFrameAtSceneTime(const struct FLiveLinkSubjectName& SubjectName, TSubclassOf<class ULiveLinkRole> Role, const struct FTimecode& SceneTime, struct FLiveLinkBaseBlueprintData* OutBlueprintData)	 // 0x5036aa4;
	static bool EvaluateLiveLinkFrameAtWorldTimeOffset(const struct FLiveLinkSubjectName& SubjectName, TSubclassOf<class ULiveLinkRole> Role, float WorldTimeOffset, struct FLiveLinkBaseBlueprintData* OutBlueprintData)	 // 0x5036d48;
	static bool EvaluateLiveLinkFrameWithSpecificRole(const struct FLiveLinkSubjectName& SubjectName, TSubclassOf<class ULiveLinkRole> Role, struct FLiveLinkBaseBlueprintData* OutBlueprintData)	 // 0x5036fe4;
	static bool GetAnimationFrameData(struct FSubjectFrameHandle& SubjectFrameHandle, struct FLiveLinkAnimationFrameData* AnimationFrameData)	 // 0x5037210;
	static bool GetAnimationStaticData(struct FSubjectFrameHandle& SubjectFrameHandle, struct FLiveLinkSkeletonStaticData* AnimationStaticData)	 // 0x50373a0;
	static void GetBasicData(struct FSubjectFrameHandle& SubjectFrameHandle, struct FLiveLinkBasicBlueprintData* BasicBlueprintData)	 // 0x5037818;
	static void GetChildren(struct FLiveLinkTransform& LiveLinkTransform, TArray<struct FLiveLinkTransform>* Children)	 // 0x50379bc;
	static void GetCurves(struct FSubjectFrameHandle& SubjectFrameHandle, TMap<class FName, float>* Curves)	 // 0x5037b14;
	static TArray<struct FLiveLinkSubjectName> GetLiveLinkEnabledSubjectNames(bool bIncludeVirtualSubject)	 // 0x5037cd0;
	static TSubclassOf<class ULiveLinkRole> GetLiveLinkSubjectRole(const struct FLiveLinkSubjectName& SubjectName)	 // 0x5037dcc;
	static TArray<struct FLiveLinkSubjectKey> GetLiveLinkSubjects(bool bIncludeDisabledSubject, bool bIncludeVirtualSubject)	 // 0x5037ed0;
	static void GetMetadata(struct FSubjectFrameHandle& SubjectFrameHandle, struct FSubjectMetadata* MetaData)	 // 0x50380a4;
	static void GetParent(struct FLiveLinkTransform& LiveLinkTransform, struct FLiveLinkTransform* Parent)	 // 0x503828c;
	static bool GetPropertyValue(struct FLiveLinkBasicBlueprintData& BasicData, class FName PropertyName, float* Value)	 // 0x5038464;
	static void GetRootTransform(struct FSubjectFrameHandle& SubjectFrameHandle, struct FLiveLinkTransform* LiveLinkTransform)	 // 0x50386a8;
	static class FText GetSourceMachineName(struct FLiveLinkSourceHandle& SourceHandle)	 // 0x503887c;
	static class FText GetSourceStatus(struct FLiveLinkSourceHandle& SourceHandle)	 // 0x50389b0;
	static class FText GetSourceType(struct FLiveLinkSourceHandle& SourceHandle)	 // 0x5038ae4;
	static class FText GetSourceTypeFromGuid(const struct FGuid& SourceGuid)	 // 0x5038c18;
	static TSubclassOf<class ULiveLinkRole> GetSpecificLiveLinkSubjectRole(const struct FLiveLinkSubjectKey& SubjectKey)	 // 0x5038d18;
	static void GetTransformByIndex(struct FSubjectFrameHandle& SubjectFrameHandle, int32 TransformIndex, struct FLiveLinkTransform* LiveLinkTransform)	 // 0x503949c;
	static void GetTransformByName(struct FSubjectFrameHandle& SubjectFrameHandle, class FName TransformName_0, struct FLiveLinkTransform* LiveLinkTransform)	 // 0x5039748;
	static bool HasParent(struct FLiveLinkTransform& LiveLinkTransform)	 // 0x50399a8;
	static bool IsLiveLinkSubjectEnabled(const struct FLiveLinkSubjectName& SubjectName)	 // 0x5039ab0;
	static bool IsSourceStillValid(struct FLiveLinkSourceHandle& SourceHandle)	 // 0x5039bb8;
	static bool IsSpecificLiveLinkSubjectEnabled(const struct FLiveLinkSubjectKey& SubjectKey, bool bForThisFrame)	 // 0x5039cac;
	static int32 NumberOfTransforms(struct FSubjectFrameHandle& SubjectFrameHandle)	 // 0x5039e40;
	static void ParentBoneSpaceTransform(struct FLiveLinkTransform& LiveLinkTransform, struct FTransform* Transform)	 // 0x5039f30;
	static bool RemoveSource(struct FLiveLinkSourceHandle& SourceHandle)	 // 0x503a0e4;
	static void SetLiveLinkSubjectEnabled(const struct FLiveLinkSubjectKey& SubjectKey, bool bEnabled)	 // 0x503a1c4;
	static void TransformName(struct FLiveLinkTransform& LiveLinkTransform, class FName* Name_0)	 // 0x503a358;
	static void TransformNames(struct FSubjectFrameHandle& SubjectFrameHandle, TArray<class FName>* TransformNames_0)	 // 0x503a4d0;
...
public:
	...
	static class ULiveLinkBlueprintLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	void OnInitialize()	 // 0xae1e64;
	void OnUpdate()	 // 0xae1e64;
	bool UpdateVirtualSubjectFrameData_Internal(const struct FLiveLinkBaseFrameData& InStruct, bool bInShouldStampCurrentTime)	 // 0x503a62c;
	bool UpdateVirtualSubjectStaticData_Internal(const struct FLiveLinkBaseStaticData& InStruct)	 // 0x503a7b4;
...
public:
	...
	static class ULiveLinkBlueprintVirtualSubject* GetDefaultObj()	 // 0x0
	{
...
public:
	void GetAvailableSubjectNames(TArray<class FName>* SubjectNames)	 // 0x503777c;
	void GetSubjectData(const class FName SubjectName, bool* bSuccess, struct FSubjectFrameHandle* SubjectFrameHandle)	 // 0x5038e3c;
	void GetSubjectDataAtSceneTime(const class FName SubjectName, const struct FTimecode& SceneTime, bool* bSuccess, struct FSubjectFrameHandle* SubjectFrameHandle)	 // 0x5038ff0;
	void GetSubjectDataAtWorldTime(const class FName SubjectName, const float WorldTime, bool* bSuccess, struct FSubjectFrameHandle* SubjectFrameHandle)	 // 0x5039264;
...
public:
	...
	static class ULiveLinkComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkDrivenComponent* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(ULiveLinkDrivenComponent) == 0x0000D8, "Wrong size on ULiveLinkDrivenComponent");
...
static_assert(offsetof(ULiveLinkDrivenComponent, ActorTransformBone) == 0x0000C8, "Member 'ULiveLinkDrivenComponent::ActorTransformBone' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, bModifyActorTransform) == 0x0000D0, "Member 'ULiveLinkDrivenComponent::bModifyActorTransform' has a wrong offset!");
static_assert(offsetof(ULiveLinkDrivenComponent, bSetRelativeLocation) == 0x0000D1, "Member 'ULiveLinkDrivenComponent::bSetRelativeLocation' has a wrong offset!");
...
public:
	static void ConnectToProvider(struct FProviderPollResult& Provider, struct FLiveLinkSourceHandle* SourceHandle)	 // 0x503674c;
	static class ULiveLinkMessageBusFinder* ConstructMessageBusFinder()	 // 0x50368c8;

	void GetAvailableProviders(class UObject* WorldContextObject, const struct FLatentActionInfo& LatentInfo, float Duration, TArray<struct FProviderPollResult>* AvailableProviders)	 // 0x5037544;
...
public:
	...
	static class ULiveLinkMessageBusFinder* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkMessageBusSourceSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	void ApplyToClientLatent(class UObject* WorldContextObject, const struct FLatentActionInfo& LatentInfo)	 // 0x50362f0;
	void BuildFromClient()	 // 0x5036458;

	bool AddToClient(const bool bRecreatePresets) const	 // 0x50361fc;
	bool ApplyToClient() const	 // 0x50362cc;
...
public:
	...
	static class ULiveLinkPreset* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkUserSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkTimecodeProvider* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkTimeSynchronizationSource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkVirtualSubjectSourceSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkAnimationAxisSwitchPreProcessor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkAnimationRoleToTransform* GetDefaultObj()	 // 0x0
	{

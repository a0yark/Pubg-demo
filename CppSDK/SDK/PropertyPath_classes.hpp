...
public:
	void SetFloat(float InFloat)	 // 0x6593138;
	void SetStruct(const struct FPropertyPathTestStruct& InStruct)	 // 0x6593200;
	void SetStructConstRef(const struct FPropertyPathTestStruct& InStruct)	 // 0x65932e4;
	void SetStructRef(const struct FPropertyPathTestStruct& InStruct)	 // 0x65933c8;

	float GetFloat() const	 // 0x6593098;
	struct FPropertyPathTestStruct GetStruct() const	 // 0x65930b4;
	const struct FPropertyPathTestStruct GetStructConstRef() const	 // 0x65930f0;
	struct FPropertyPathTestStruct GetStructRef() const	 // 0x6593114;
...
public:
	...
	static class UPropertyPathTestObject* GetDefaultObj()	 // 0x0
	{

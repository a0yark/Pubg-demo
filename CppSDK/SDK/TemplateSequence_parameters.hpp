...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x0820)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetCameraCachePOV) == 0x000830, "Wrong size on SequenceCameraShakeTestUtil_GetCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV) == 0x000830, "Wrong size on SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV");
...
public:
	...
	struct FPostProcessSettings                   OutPPSettings;                                     // 0x0010(0x0740)(Parm, OutParm, NativeAccessSpecifierPublic)
	float                                         OutPPBlendWeight;                                  // 0x0750(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0754(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_755[0xB];                                      // 0x0755(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache) == 0x000760, "Wrong size on SequenceCameraShakeTestUtil_GetPostProcessBlendCache");
...
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, OutPPBlendWeight) == 0x000750, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::OutPPBlendWeight' has a wrong offset!");
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, ReturnValue) == 0x000754, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::ReturnValue' has a wrong offset!");

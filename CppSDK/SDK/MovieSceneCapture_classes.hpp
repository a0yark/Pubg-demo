...
public:
	EMovieSceneCaptureProtocolState GetState() const	 // 0x3d6a240;
	bool IsCapturing() const	 // 0x6850bd8;
...
public:
	...
	static class UMovieSceneCaptureProtocolBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneAudioCaptureProtocolBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UNullAudioCaptureProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMasterAudioSubmixCaptureProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneImageCaptureProtocolBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCompositionGraphCaptureProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IMovieSceneCaptureInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UFrameGrabberProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UImageSequenceProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCompressedImageSequenceProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UImageSequenceProtocol_BMP* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UImageSequenceProtocol_PNG* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UImageSequenceProtocol_JPG* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UImageSequenceProtocol_EXR* GetDefaultObj()	 // 0x0
	{
...
public:
	class UMovieSceneCaptureProtocolBase* GetAudioCaptureProtocol()	 // 0x6850b00;
	class UMovieSceneCaptureProtocolBase* GetImageCaptureProtocol()	 // 0x518cf00;
	void SetAudioCaptureProtocolType(TSubclassOf<class UMovieSceneCaptureProtocolBase> ProtocolType)	 // 0x6850d58;
	void SetImageCaptureProtocolType(TSubclassOf<class UMovieSceneCaptureProtocolBase> ProtocolType)	 // 0x6850e18;
...
public:
	...
	static class UMovieSceneCapture* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULevelCapture* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static class UMovieSceneAudioCaptureProtocolBase* FindAudioCaptureProtocol()	 // 0x68507e8;
	static class UMovieSceneImageCaptureProtocolBase* FindImageCaptureProtocol()	 // 0x6850850;
	static float GetCaptureElapsedTime()	 // 0x6850b18;
	static int32 GetCaptureFrameNumber()	 // 0x6850b40;
	static bool IsCaptureInProgress()	 // 0x6850ba4;
...
public:
	...
	static class UMovieSceneCaptureEnvironment* GetDefaultObj()	 // 0x0
	{
...
public:
	void OnBeginFinalize()	 // 0xae1e64;
	void OnCaptureFrame()	 // 0xae1e64;
	void OnFinalize()	 // 0xae1e64;
	void OnPauseCapture()	 // 0xae1e64;
	void OnPixelsReceived(const struct FCapturedPixels& Pixels, const struct FCapturedPixelsID& ID, const struct FFrameMetrics& FrameMetrics)	 // 0xae1e64;
	void OnPreTick()	 // 0xae1e64;
	bool OnSetup()	 // 0x56785dc;
	void OnStartCapture()	 // 0xae1e64;
	void OnTick()	 // 0xae1e64;
	void OnWarmUp()	 // 0xae1e64;
	void ResolveBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& BufferID)	 // 0x6850bf8;
	void StartCapturingFinalPixels(const struct FCapturedPixelsID& StreamID)	 // 0x6850ed8;
	void StopCapturingFinalPixels()	 // 0x6850fd0;

	class FString GenerateFilename(const struct FFrameMetrics& InFrameMetrics) const	 // 0x6850874;
	struct FFrameMetrics GetCurrentFrameMetrics() const	 // 0x6850b8c;
	bool OnCanFinalize() const	 // 0x1768c8c;
...
public:
	...
	static class UUserDefinedCaptureProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	class FString GenerateFilenameForBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& StreamID)	 // 0x6850934;
	class FString GenerateFilenameForCurrentFrame()	 // 0x6850ab4;
	void WriteImageToDisk(const struct FCapturedPixels& PixelData, const struct FCapturedPixelsID& StreamID, const struct FFrameMetrics& FrameMetrics, bool bCopyImageData)	 // 0x6850fe4;
...
public:
	...
	static class UUserDefinedImageCaptureProtocol* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UVideoCaptureProtocol* GetDefaultObj()	 // 0x0
	{

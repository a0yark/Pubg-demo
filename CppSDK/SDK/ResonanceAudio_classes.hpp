...
public:
	void SetSoundSourceDirectivity(float InPattern, float InSharpness)	 // 0x55af21c;
	void SetSoundSourceSpread(float InSpread)	 // 0x55af35c;
...
public:
	...
	static class UResonanceAudioSpatializationSourceSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UResonanceAudioSoundfieldSettings* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static class UResonanceAudioReverbPluginPreset* GetGlobalReverbPreset()	 // 0x55ae9d0;
	static void SetGlobalReverbPreset(class UResonanceAudioReverbPluginPreset* InPreset)	 // 0x55aeb10;
...
public:
	...
	static class UResonanceAudioBlueprintFunctionLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	class UMaterial*                              Material;                                          // 0x0320(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UResonanceAudioSpatializationSourceSettings* Settings;                                     // 0x0328(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	static class AResonanceAudioDirectivityVisualizer* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(AResonanceAudioDirectivityVisualizer) == 0x000330, "Wrong size on AResonanceAudioDirectivityVisualizer");
static_assert(offsetof(AResonanceAudioDirectivityVisualizer, Material) == 0x000320, "Member 'AResonanceAudioDirectivityVisualizer::Material' has a wrong offset!");
static_assert(offsetof(AResonanceAudioDirectivityVisualizer, Settings) == 0x000328, "Member 'AResonanceAudioDirectivityVisualizer::Settings' has a wrong offset!");
...
public:
	void SetEnableRoomEffects(bool bInEnableRoomEffects)	 // 0x55aea44;
	void SetReflectionScalar(float InReflectionScalar)	 // 0x55aec58;
	void SetReverbBrightness(float InReverbBrightness)	 // 0x55aed28;
	void SetReverbGain(float InReverbGain)	 // 0x55aedf8;
	void SetReverbTimeModifier(float InReverbTimeModifier)	 // 0x55aeec8;
	void SetRoomDimensions(const struct FVector& InDimensions)	 // 0x55aef98;
	void SetRoomMaterials(const TArray<ERaMaterialName>& InMaterials)	 // 0x55af020;
	void SetRoomPosition(const struct FVector& InPosition)	 // 0x55af10c;
	void SetRoomRotation(const struct FQuat& InRotation)	 // 0x55af194;
...
public:
	...
	static class UResonanceAudioReverbPluginPreset* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UResonanceAudioSettings* GetDefaultObj()	 // 0x0
	{

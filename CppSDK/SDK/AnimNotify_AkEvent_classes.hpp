...
public:
	bool Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, const struct FAnimNotifyEventReference& EventReference) const	 // 0xae1e64;
...
public:
	...
	static class UAnimNotify_AkEvent_C* GetDefaultObj()	 // 0x0
	{

...
public:
	void SetAngularOffset(float InValue)	 // 0x71f1ae0;
	void SetCenterBackgroundColor(const struct FLinearColor& InValue)	 // 0x71f1bac;
	void SetCustomDefaultValue(float InValue)	 // 0x71f1c8c;
	void SetHandStartEndRatio(const struct FVector2D& InValue)	 // 0x71f1d50;
	void SetLocked(bool InValue)	 // 0x71f1e20;
	void SetShowSliderHand(bool InShowSliderHand)	 // 0x71f1f4c;
	void SetShowSliderHandle(bool InShowSliderHandle)	 // 0x71f2018;
	void SetSliderBarColor(const struct FLinearColor& InValue)	 // 0x71f20e4;
	void SetSliderHandleColor(const struct FLinearColor& InValue)	 // 0x71f21c4;
	void SetSliderHandleEndAngle(float InValue)	 // 0x71f22a4;
	void SetSliderHandleStartAngle(float InValue)	 // 0x71f2378;
	void SetSliderProgressColor(const struct FLinearColor& InValue)	 // 0x71f244c;
	void SetSliderRange(const struct FRuntimeFloatCurve& InSliderRange)	 // 0x71f252c;
	void SetStepSize(float InValue)	 // 0x71f2618;
	void SetUseVerticalDrag(bool InUseVerticalDrag)	 // 0x71f26dc;
	void SetValue(float InValue)	 // 0x71f27a8;
	void SetValueTags(const TArray<float>& InValueTags)	 // 0x71f286c;

	float GetCustomDefaultValue() const	 // 0x71f1a58;
	float GetNormalizedSliderHandlePosition() const	 // 0x71f1a80;
	float GetValue() const	 // 0x71f1ab8;
...
public:
	...
	static class URadialSlider* GetDefaultObj()	 // 0x0
	{

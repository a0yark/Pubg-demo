...
// Function Water.WaterBodyOcean.GetWaveHeightAt
// 0x0020 (0x0020 - 0x0000)
struct WaterBodyOcean_GetWaveHeightAt final
{
public:
...
static_assert(alignof(WaterBodyOcean_GetWaveHeightAt) == 0x000008, "Wrong alignment on WaterBodyOcean_GetWaveHeightAt");
static_assert(sizeof(WaterBodyOcean_GetWaveHeightAt) == 0x000020, "Wrong size on WaterBodyOcean_GetWaveHeightAt");
static_assert(offsetof(WaterBodyOcean_GetWaveHeightAt, Location) == 0x000000, "Member 'WaterBodyOcean_GetWaveHeightAt::Location' has a wrong offset!");
static_assert(offsetof(WaterBodyOcean_GetWaveHeightAt, ReturnValue) == 0x000018, "Member 'WaterBodyOcean_GetWaveHeightAt::ReturnValue' has a wrong offset!");

...
enum class EVCamInputMode : uint8
{
	Allow                                    = 0,
	Ignore                                   = 1,
	EVCamInputMode_MAX                       = 2,
};

// Enum VCamCore.EVCamGamepadInputMode
// NumValues: 0x0005
...
{
public:
	TSoftObjectPtr<class UWidget>                 Template;                                          // 0x0000(0x0030)(Edit, ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FChildWidgetReference) == 0x000008, "Wrong alignment on FChildWidgetReference");
static_assert(sizeof(FChildWidgetReference) == 0x000030, "Wrong size on FChildWidgetReference");
...
static_assert(sizeof(FVCamChildWidgetReference) == 0x000030, "Wrong size on FVCamChildWidgetReference");
...
{
public:
	struct FVCamChildWidgetReference              Widget;                                            // 0x0000(0x0030)(Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TMap<class FName, struct FVCamConnectionTargetSettings> ConnectionTargets;                       // 0x0030(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetConnectionConfig) == 0x000008, "Wrong alignment on FWidgetConnectionConfig");
static_assert(sizeof(FWidgetConnectionConfig) == 0x000080, "Wrong size on FWidgetConnectionConfig");
static_assert(offsetof(FWidgetConnectionConfig, Widget) == 0x000000, "Member 'FWidgetConnectionConfig::Widget' has a wrong offset!");
static_assert(offsetof(FWidgetConnectionConfig, ConnectionTargets) == 0x000030, "Member 'FWidgetConnectionConfig::ConnectionTargets' has a wrong offset!");
...
public:
	...
	EVCamInputMode                                KeyboardInputMode;                                 // 0x0018(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVCamInputMode                                MouseInputMode;                                    // 0x0019(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVCamGamepadInputMode                         GamepadInputMode;                                  // 0x001A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVCamInputLoggingMode                         LoggingMode;                                       // 0x001B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FVCamInputDeviceConfig, KeyboardInputMode) == 0x000018, "Member 'FVCamInputDeviceConfig::KeyboardInputMode' has a wrong offset!");
static_assert(offsetof(FVCamInputDeviceConfig, MouseInputMode) == 0x000019, "Member 'FVCamInputDeviceConfig::MouseInputMode' has a wrong offset!");
static_assert(offsetof(FVCamInputDeviceConfig, GamepadInputMode) == 0x00001A, "Member 'FVCamInputDeviceConfig::GamepadInputMode' has a wrong offset!");
static_assert(offsetof(FVCamInputDeviceConfig, LoggingMode) == 0x00001B, "Member 'FVCamInputDeviceConfig::LoggingMode' has a wrong offset!");

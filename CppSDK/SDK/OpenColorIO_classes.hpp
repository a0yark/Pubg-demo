...
public:
	...
	static class UOpenColorIOSettings* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static bool ApplyColorSpaceTransform(const class UObject* WorldContextObject, const struct FOpenColorIOColorConversionSettings& ConversionSettings, class UTexture* InputTexture, class UTextureRenderTarget2D* OutputRenderTarget)	 // 0x4f4b224;
...
public:
	...
	static class UOpenColorIOBlueprintLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UOpenColorIOColorTransform* GetDefaultObj()	 // 0x0
	{
...
public:
	void ReloadExistingColorspaces()	 // 0x17c7f2c;
...
public:
	...
	static class UOpenColorIOConfiguration* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UOpenColorIODisplayExtensionWrapper* CreateInGameOpenColorIODisplayExtension(const struct FOpenColorIODisplayConfiguration& InDisplayConfiguration)	 // 0x4f4b790;
	static class UOpenColorIODisplayExtensionWrapper* CreateOpenColorIODisplayExtension(const struct FOpenColorIODisplayConfiguration& InDisplayConfiguration, const struct FSceneViewExtensionIsActiveFunctor& IsActiveFunction)	 // 0x4f4b878;

	void RemoveSceneExtension()	 // 0x4f4ba54;
	void SetOpenColorIOConfiguration(const struct FOpenColorIODisplayConfiguration& InDisplayConfiguration)	 // 0x4f4ba6c;
	void SetSceneExtensionIsActiveFunction(const struct FSceneViewExtensionIsActiveFunctor& IsActiveFunction)	 // 0x4f4bb54;
	void SetSceneExtensionIsActiveFunctions(const TArray<struct FSceneViewExtensionIsActiveFunctor>& IsActiveFunctions)	 // 0x4f4bc14;

	struct FOpenColorIODisplayConfiguration GetOpenColorIOConfiguration() const	 // 0x4f4b9f0;
...
public:
	...
	static class UOpenColorIODisplayExtensionWrapper* GetDefaultObj()	 // 0x0
	{

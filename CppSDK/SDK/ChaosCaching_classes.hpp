...
public:
	...
	static class UChaosCacheCollection* GetDefaultObj()	 // 0x0
	{
...
{
public:
	class UChaosCacheCollection*                  CacheCollection;                                   // 0x02B0(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	void ResetAllComponentTransforms()	 // 0x51f391c;
	void ResetSingleTransform(int32 InIndex)	 // 0x51f3930;
	void SetStartTime(float InStartTime)	 // 0x51f3a38;
	void TriggerAll()	 // 0x51f3afc;
	void TriggerComponent(class UPrimitiveComponent* InComponent)	 // 0x51f3b80;
	void TriggerComponentByCache(class FName InCacheName)	 // 0x51f3c40;
...
public:
	...
	static class AChaosCacheManager* GetDefaultObj()	 // 0x0
	{
...
static_assert(offsetof(AChaosCacheManager, CacheCollection) == 0x0002B0, "Member 'AChaosCacheManager::CacheCollection' has a wrong offset!");
static_assert(offsetof(AChaosCacheManager, CacheMode) == 0x0002B8, "Member 'AChaosCacheManager::CacheMode' has a wrong offset!");
static_assert(offsetof(AChaosCacheManager, StartMode) == 0x0002B9, "Member 'AChaosCacheManager::StartMode' has a wrong offset!");
static_assert(offsetof(AChaosCacheManager, StartTime) == 0x0002BC, "Member 'AChaosCacheManager::StartTime' has a wrong offset!");
static_assert(offsetof(AChaosCacheManager, ObservedComponents) == 0x0002C8, "Member 'AChaosCacheManager::ObservedComponents' has a wrong offset!");
...
public:
	...
	static class AChaosCachePlayer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosCache* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneChaosCacheSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMovieSceneChaosCacheTrack* GetDefaultObj()	 // 0x0
	{

...
public:
	void SetRetargetAsset(TSubclassOf<class ULiveLinkRetargetAsset> RetargetAsset)	 // 0x71f4540;
	void SetSubject(const struct FLiveLinkSubjectName& SubjectName)	 // 0x71f4638;
...
public:
	...
	static class ULiveLinkInstance* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkRetargetAsset* GetDefaultObj()	 // 0x0
	{
...
public:
	class FName GetRemappedBoneName(class FName BoneName) const	 // 0x71f42b8;
	class FName GetRemappedCurveName(class FName CurveName) const	 // 0x71f4388;
	void RemapCurveElements(TMap<class FName, float>& CurveItems) const	 // 0x71f4458;
...
public:
	...
	static class ULiveLinkRemapAsset* GetDefaultObj()	 // 0x0
	{

...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x0820)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x0830(0x0820)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(LegacyCameraShake_BlueprintUpdateCameraShake) == 0x001050, "Wrong size on LegacyCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(LegacyCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000830, "Member 'LegacyCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");

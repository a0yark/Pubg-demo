...
public:
	...
	static class UChaosClothingSimulationInteractor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosClothConfig* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosClothSharedSimConfig* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosClothingSimulationFactory* GetDefaultObj()	 // 0x0
	{
...
public:
	void ResetAndTeleport(bool bReset, bool bTeleport)	 // 0x51db45c;
	void SetAerodynamics(float DragCoefficient, float LiftCoefficient, const struct FVector& WindVelocity)	 // 0x51db5ac;
	void SetAnimDrive(const struct FVector2D& AnimDriveStiffness, const struct FVector2D& AnimDriveDamping)	 // 0x51db778;
	void SetAnimDriveLinear(float AnimDriveStiffness)	 // 0x51db8d4;
	void SetBackstop(bool bEnabled)	 // 0x51db998;
	void SetCollision(float CollisionThickness, float FrictionCoefficient, bool bUseCCD, float SelfCollisionThickness)	 // 0x51dba5c;
	void SetDamping(float DampingCoefficient, float LocalDampingCoefficient)	 // 0x51dbca8;
	void SetGravity(float GravityScale, bool bIsGravityOverridden, const struct FVector& GravityOverride)	 // 0x51dbde8;
	void SetLongRangeAttachment(const struct FVector2D& TetherStiffness, const struct FVector2D& TetherScale)	 // 0x51dbfc4;
	void SetLongRangeAttachmentLinear(float TetherStiffness, float TetherScale)	 // 0x51dc120;
	void SetMaterial(const struct FVector2D& EdgeStiffness, const struct FVector2D& BendingStiffness, const struct FVector2D& AreaStiffness)	 // 0x51dc260;
	void SetMaterialLinear(float EdgeStiffness, float BendingStiffness, float AreaStiffness)	 // 0x51dc440;
	void SetPressure(const struct FVector2D& Pressure)	 // 0x51dc5fc;
	void SetVelocityScale(const struct FVector& LinearVelocityScale, float AngularVelocityScale, float FictitiousAngularScale)	 // 0x51dc6c4;
	void SetWind(const struct FVector2D& Drag, const struct FVector2D& Lift, float AirDensity, const struct FVector& WindVelocity)	 // 0x51dc890;
...
public:
	...
	static class UChaosClothingInteractor* GetDefaultObj()	 // 0x0
	{

...
public:
	class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* MeshComp) const	 // 0x3fe24c0;
...
public:
	...
	static class UAnimNotifyState_TimedNiagaraEffect* GetDefaultObj()	 // 0x0
	{
...
public:
	float GetNotifyProgress(class UMeshComponent* MeshComp) const	 // 0x3fe23f0;
...
public:
	...
	static class UAnimNotifyState_TimedNiagaraEffectAdvanced* GetDefaultObj()	 // 0x0
	{
...
public:
	class UFXSystemComponent* GetSpawnedEffect() const	 // 0x3fe25fc;
...
public:
	...
	static class UAnimNotify_PlayNiagaraEffect* GetDefaultObj()	 // 0x0
	{

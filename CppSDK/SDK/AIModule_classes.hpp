...
public:
	...
	static class UBTNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTAuxiliaryNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_TimeLimit* GetDefaultObj()	 // 0x0
	{
...
public:
	void RegisterForSense(TSubclassOf<class UAISense> SenseClass)	 // 0x713c9f8;
	void RegisterWithPerceptionSystem()	 // 0x713cd58;
	void UnregisterFromPerceptionSystem()	 // 0x713e1d8;
	void UnregisterFromSense(TSubclassOf<class UAISense> SenseClass)	 // 0x713e1ec;
...
public:
	...
	static class UAIPerceptionStimuliSourceComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAIResource_Movement* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryDebugHelpers* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryNode* GetDefaultObj()	 // 0x0
	{
...
public:
	void ReceiveSmartLinkReached(class AActor* Agent, const struct FVector& Destination)	 // 0xae1e64;
	void ResumePathFollowing(class AActor* Agent)	 // 0x712f9fc;
	void SetSmartLinkEnabled(bool bEnabled)	 // 0x712fd98;

	bool HasMovingAgents() const	 // 0x712f2a8;
	bool IsSmartLinkEnabled() const	 // 0x712f310;
...
public:
	...
	static class ANavLinkProxy* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	class UCurveFloat*                            CustomScoringCurve;                                // 0x0100(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEnvQueryTestClamping                         ClampMinType;                                      // 0x0108(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEnvQueryTestClamping                         ClampMaxType;                                      // 0x0109(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEQSNormalizationType                         NormalizationType;                                 // 0x010A(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10B[0x5];                                      // 0x010B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIDataProviderFloatValue              ScoreClampMin;                                     // 0x0110(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ScoreClampMax;                                     // 0x0148(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ScoringFactor;                                     // 0x0180(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ReferenceValue;                                    // 0x01B8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bDefineReferenceValue;                             // 0x01F0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1F1[0xF];                                      // 0x01F1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bWorkOnFloatValues : 1;                            // 0x0200(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
public:
	...
	static class UEnvQueryTest* GetDefaultObj()	 // 0x0
	{
		return GetDefaultObjImpl<UEnvQueryTest>();
	}
};
static_assert(alignof(UEnvQueryTest) == 0x000008, "Wrong alignment on UEnvQueryTest");
static_assert(sizeof(UEnvQueryTest) == 0x000208, "Wrong size on UEnvQueryTest");
...
static_assert(offsetof(UEnvQueryTest, CustomScoringCurve) == 0x000100, "Member 'UEnvQueryTest::CustomScoringCurve' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ClampMinType) == 0x000108, "Member 'UEnvQueryTest::ClampMinType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ClampMaxType) == 0x000109, "Member 'UEnvQueryTest::ClampMaxType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, NormalizationType) == 0x00010A, "Member 'UEnvQueryTest::NormalizationType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoreClampMin) == 0x000110, "Member 'UEnvQueryTest::ScoreClampMin' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoreClampMax) == 0x000148, "Member 'UEnvQueryTest::ScoreClampMax' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoringFactor) == 0x000180, "Member 'UEnvQueryTest::ScoringFactor' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ReferenceValue) == 0x0001B8, "Member 'UEnvQueryTest::ReferenceValue' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, bDefineReferenceValue) == 0x0001F0, "Member 'UEnvQueryTest::bDefineReferenceValue' has a wrong offset!");
...
public:
	...
	static class UEnvQueryItemType* GetDefaultObj()	 // 0x0
	{
...
public:
	void ClearValue(const class FName& KeyName)	 // 0x70e6568;
	void SetValueAsBool(const class FName& KeyName, bool BoolValue)	 // 0x70e97fc;
	void SetValueAsClass(const class FName& KeyName, class UClass* ClassValue)	 // 0x70e990c;
	void SetValueAsEnum(const class FName& KeyName, uint8 EnumValue)	 // 0x70e9a1c;
	void SetValueAsFloat(const class FName& KeyName, float FloatValue)	 // 0x70e9b2c;
	void SetValueAsInt(const class FName& KeyName, int32 IntValue)	 // 0x70e9c3c;
	void SetValueAsName(const class FName& KeyName, class FName NameValue)	 // 0x70e9d48;
	void SetValueAsObject(const class FName& KeyName, class UObject* ObjectValue)	 // 0x70e9e70;
	void SetValueAsRotator(const class FName& KeyName, const struct FRotator& VectorValue)	 // 0x70e9f80;
	void SetValueAsString(const class FName& KeyName, const class FString& StringValue)	 // 0x70ea0b4;
	void SetValueAsVector(const class FName& KeyName, const struct FVector& VectorValue)	 // 0x70ea218;

	bool GetLocationFromEntry(const class FName& KeyName, struct FVector* ResultLocation) const	 // 0x70e74bc;
	bool GetRotationFromEntry(const class FName& KeyName, struct FRotator* ResultRotation) const	 // 0x70e7748;
	bool GetValueAsBool(const class FName& KeyName) const	 // 0x70e7914;
	class UClass* GetValueAsClass(const class FName& KeyName) const	 // 0x70e79ac;
	uint8 GetValueAsEnum(const class FName& KeyName) const	 // 0x70e7a48;
	float GetValueAsFloat(const class FName& KeyName) const	 // 0x70e7ae0;
	int32 GetValueAsInt(const class FName& KeyName) const	 // 0x70e7b7c;
	class FName GetValueAsName(const class FName& KeyName) const	 // 0x70e7c14;
	class UObject* GetValueAsObject(const class FName& KeyName) const	 // 0x70e7ca8;
	struct FRotator GetValueAsRotator(const class FName& KeyName) const	 // 0x70e7d44;
	class FString GetValueAsString(const class FName& KeyName) const	 // 0x70e7df0;
	struct FVector GetValueAsVector(const class FName& KeyName) const	 // 0x70e7ea4;
	bool IsVectorValueSet(const class FName& KeyName) const	 // 0x70e8030;
...
public:
	...
	static class UBlackboardComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_ProjectedPoints* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_Donut* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTService* GetDefaultObj()	 // 0x0
	{
...
public:
	void ForgetAll()	 // 0x712eb6c;
	bool GetActorsPerception(class AActor* Actor, struct FActorPerceptionBlueprintInfo* Info)	 // 0x712eb80;
	void OnOwnerEndPlay(class AActor* Actor, EEndPlayReason EndPlayReason)	 // 0x712f6e0;
	void RequestStimuliListenerUpdate()	 // 0x712f9e8;
	void SetSenseEnabled(TSubclassOf<class UAISense> SenseClass, const bool bEnable)	 // 0x712fc58;

	void GetCurrentlyPerceivedActors(TSubclassOf<class UAISense> SenseToUse, TArray<class AActor*>* OutActors) const	 // 0x712edc0;
	void GetKnownPerceivedActors(TSubclassOf<class UAISense> SenseToUse, TArray<class AActor*>* OutActors) const	 // 0x712eef0;
	void GetPerceivedActors(TSubclassOf<class UAISense> SenseToUse, TArray<class AActor*>* OutActors) const	 // 0x712edc0;
	void GetPerceivedHostileActors(TArray<class AActor*>* OutActors) const	 // 0x712f0d8;
	void GetPerceivedHostileActorsBySense(const TSubclassOf<class UAISense> SenseToUse, TArray<class AActor*>* OutActors) const	 // 0x712f178;
...
public:
	...
	static class UAIPerceptionComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISubsystem* GetDefaultObj()	 // 0x0
	{
...
public:
	void ClaimTaskResource(TSubclassOf<class UGameplayTaskResource> ResourceClass)	 // 0x70cd04c;
	class UAIPerceptionComponent* GetAIPerceptionComponent()	 // 0x4fc112c;
	void K2_ClearFocus()	 // 0x70cd6b4;
	void K2_SetFocalPoint(const struct FVector& FP)	 // 0x70cdb60;
	void K2_SetFocus(class AActor* NewFocus)	 // 0x70cdc38;
	EPathFollowingRequestResult MoveToActor(class AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath)	 // 0x70cdd00;
	EPathFollowingRequestResult MoveToLocation(const struct FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath)	 // 0x70ce0c4;
	void OnGameplayTaskResourcesClaimed(const struct FGameplayResourceSet& NewlyClaimed, const struct FGameplayResourceSet& FreshlyReleased)	 // 0x70ce510;
	void OnUsingBlackBoard(class UBlackboardComponent* BlackboardComp, class UBlackboardData* BlackboardAsset)	 // 0xae1e64;
	bool RunBehaviorTree(class UBehaviorTree* BTAsset)	 // 0x70ce794;
	void SetMoveBlockDetection(bool bEnable)	 // 0x70ce86c;
	void SetPathFollowingComponent(class UPathFollowingComponent* NewPFComponent)	 // 0x70ce968;
	void UnclaimTaskResource(TSubclassOf<class UGameplayTaskResource> ResourceClass)	 // 0x70cea28;
	bool UseBlackboard(class UBlackboardData* BlackboardAsset, class UBlackboardComponent** BlackboardComponent)	 // 0x70ceae8;

	class UPawnActionsComponent* GetDeprecatedActionsComponent() const	 // 0x56936d8;
	struct FVector GetFocalPoint() const	 // 0x70cd3d4;
	struct FVector GetFocalPointOnActor(const class AActor* Actor) const	 // 0x70cd40c;
	class AActor* GetFocusActor() const	 // 0x70cd4f4;
	struct FVector GetImmediateMoveDestination() const	 // 0x70cd518;
	EPathFollowingStatus GetMoveStatus() const	 // 0x70cd578;
	class UPathFollowingComponent* GetPathFollowingComponent() const	 // 0x4a89860;
	bool HasPartialPath() const	 // 0x70cd5a0;
...
public:
	...
	static class AAIController* GetDefaultObj()	 // 0x0
	{
		return GetDefaultObjImpl<AAIController>();
	}
};
static_assert(alignof(AAIController) == 0x000008, "Wrong alignment on AAIController");
static_assert(sizeof(AAIController) == 0x0003D8, "Wrong size on AAIController");
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x000388, "Member 'AAIController::PathFollowingComponent' has a wrong offset!");
static_assert(offsetof(AAIController, BrainComponent) == 0x000390, "Member 'AAIController::BrainComponent' has a wrong offset!");
static_assert(offsetof(AAIController, PerceptionComponent) == 0x000398, "Member 'AAIController::PerceptionComponent' has a wrong offset!");
static_assert(offsetof(AAIController, ActionsComp) == 0x0003A0, "Member 'AAIController::ActionsComp' has a wrong offset!");
static_assert(offsetof(AAIController, Blackboard) == 0x0003A8, "Member 'AAIController::Blackboard' has a wrong offset!");
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x0003B0, "Member 'AAIController::CachedGameplayTasksComponent' has a wrong offset!");
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x0003B8, "Member 'AAIController::DefaultNavigationFilterClass' has a wrong offset!");
static_assert(offsetof(AAIController, ReceiveMoveCompleted) == 0x0003C0, "Member 'AAIController::ReceiveMoveCompleted' has a wrong offset!");
...
public:
	static TSubclassOf<class UAISense> GetSenseClassForStimulus(class UObject* WorldContextObject, const struct FAIStimulus& Stimulus)	 // 0x713c860;
	static bool RegisterPerceptionStimuliSource(class UObject* WorldContextObject, TSubclassOf<class UAISense> Sense, class AActor* Target)	 // 0x713cb44;
	static void ReportPerceptionEvent(class UObject* WorldContextObject, class UAISenseEvent* PerceptionEvent)	 // 0x713d6c4;

	void OnPerceptionStimuliSourceEndPlay(class AActor* Actor, EEndPlayReason EndPlayReason)	 // 0x1771864;
	void ReportEvent(class UAISenseEvent* PerceptionEvent)	 // 0x713d208;
...
public:
	...
	static class UAIPerceptionSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UPawnAction* CreateActionInstance(class UObject* WorldContextObject, TSubclassOf<class UPawnAction> ActionClass)	 // 0x70cd184;

	void Finish(EPawnActionResult WithResult)	 // 0x70cd310;
	EAIRequestPriority GetActionPriority()	 // 0x5729350;
...
public:
	...
	static class UPawnAction* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPawnAction_Move* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISense* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTService_BlackboardBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseEvent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPawnAction_Sequence* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_BlackboardBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Hearing* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseEvent_Hearing* GetDefaultObj()	 // 0x0
	{
...
public:
	static void ReportNoiseEvent(class UObject* WorldContextObject, const struct FVector& NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, class FName Tag, const struct FGameplayTagContainer& GameplayTags)	 // 0x713d30c;
...
public:
	...
	static class UAISense_Hearing* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IEQSQueryResultSourceInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Sight* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISense_Sight* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IAIResourceInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTaskNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_BlackboardBase* GetDefaultObj()	 // 0x0
	{
...
public:
	static void RequestControllerPredictionEvent(class AAIController* Requestor, class AActor* PredictedActor, float PredictionTime)	 // 0x713db3c;
	static void RequestPawnPredictionEvent(class APawn* Requestor, class AActor* PredictedActor, float PredictionTime)	 // 0x713dcf4;
...
public:
	...
	static class UAISense_Prediction* GetDefaultObj()	 // 0x0
	{
...
public:
	void AIIgnorePlayers()	 // 0x172fbe0;
	void AILoggingVerbose()	 // 0x3d9afa4;
...
public:
	...
	static class UAISystem* GetDefaultObj()	 // 0x0
	{
...
{
public:
	TSubclassOf<class UEnvQueryContext>           VolumeContext;                                     // 0x0208(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class AVolume>                    VolumeClass;                                       // 0x0210(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bDoComplexVolumeTest : 1;                          // 0x0218(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
public:
	...
	static class UEnvQueryTest_Volume* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Volume) == 0x000220, "Wrong size on UEnvQueryTest_Volume");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeContext) == 0x000208, "Member 'UEnvQueryTest_Volume::VolumeContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeClass) == 0x000210, "Member 'UEnvQueryTest_Volume::VolumeClass' has a wrong offset!");
...
{
public:
	void ActionFinished(class APawn* ControlledPawn, EPawnActionResult WithResult)	 // 0xae1e64;
	void ActionPause(class APawn* ControlledPawn)	 // 0xae1e64;
	void ActionResume(class APawn* ControlledPawn)	 // 0xae1e64;
	void ActionStart(class APawn* ControlledPawn)	 // 0xae1e64;
	void ActionTick(class APawn* ControlledPawn, float DeltaSeconds)	 // 0xae1e64;
...
public:
	...
	static class UPawnAction_BlueprintBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ADetourCrowdAIController* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(ADetourCrowdAIController) == 0x0003D8, "Wrong size on ADetourCrowdAIController");
...
public:
	...
	static class UBTDecorator_Cooldown* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Team* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTService_RunEQS* GetDefaultObj()	 // 0x0
	{
...
public:
	void ReceiveActivation(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveActivationAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveDeactivation(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveDeactivationAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveSearchStart(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveSearchStartAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds)	 // 0xae1e64;
	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)	 // 0xae1e64;

	bool IsServiceActive() const	 // 0x710fd50;
...
public:
	...
	static class UBTService_BlueprintBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAIDataProvider* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAIDataProvider_QueryParams* GetDefaultObj()	 // 0x0
	{
...
public:
	void FinishAbort()	 // 0x710f2fc;
	void FinishExecute(bool bSuccess)	 // 0x710f364;
	void ReceiveAbort(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	...
	void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds)	 // 0xae1e64;
	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)	 // 0xae1e64;
	void SetFinishOnMessage(class FName MessageName)	 // 0x7110a14;
	void SetFinishOnMessageWithId(class FName MessageName, int32 RequestID)	 // 0x7110af4;

	bool IsTaskAborting() const	 // 0x710fda8;
	bool IsTaskExecuting() const	 // 0x710fdc4;
...
public:
	...
	static class UBTTask_BlueprintBase* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetNamedParam(class FName ParamName, float Value)	 // 0x7110c50;

	float GetItemScore(int32 ItemIndex) const	 // 0x710f950;
	bool GetQueryResultsAsActors(TArray<class AActor*>* ResultActors) const	 // 0x710fb28;
	bool GetQueryResultsAsLocations(TArray<struct FVector>* ResultLocations) const	 // 0x710fbd4;
	TArray<class AActor*> GetResultsAsActors() const	 // 0x710fc80;
	TArray<struct FVector> GetResultsAsLocations() const	 // 0x710fcc0;
...
public:
	...
	static class UEnvQueryInstanceBlueprintWrapper* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryContext* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IGenericTeamAgentInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_SimpleGrid* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPawnAction_Repeat* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryContext_Item* GetDefaultObj()	 // 0x0
	{
...
public:
	void RestartLogic()	 // 0x4aa5f24;
	void StartLogic()	 // 0x4abbd98;
	void StopLogic(const class FString& Reason)	 // 0x71113a4;

	bool IsPaused() const	 // 0x710fd00;
	bool IsRunning() const	 // 0x710fd28;
...
public:
	...
	static class UBrainComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Prediction* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryItemType_VectorBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryItemType_ActorBase* GetDefaultObj()	 // 0x0
	{
...
public:
	void OnMoveCompleted(const struct FAIRequestID& RequestID, EPathFollowingResult MovementResult)	 // 0x70ce654;
...
public:
	...
	static class UAIAsyncTaskBlueprintProxy* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryItemType_Actor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_ForceSuccess* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAITask* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryTypes* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTCompositeNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseBlueprintListener* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Blueprint* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Touch* GetDefaultObj()	 // 0x0
	{
...
{
public:
	struct FAIDamageEvent                         Event;                                             // 0x0028(0x0070)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	static class UAISenseEvent_Damage* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ICrowdAgentInterface* GetDefaultObj()	 // 0x0
	{
...
{
public:
	class APawn*                                  ControlledPawn;                                    // 0x00C0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPawnAction*                            CurrentAction;                                     // 0x00E8(0x0008)(ZeroConstructor, Transient, Deprecated, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F0[0x8];                                       // 0x00F0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static bool K2_PerformAction(class APawn* Pawn, class UPawnAction* Action, EAIRequestPriority Priority)	 // 0x70cd79c;

	EPawnActionAbortState K2_AbortAction(class UPawnAction* ActionToAbort)	 // 0x70cd5dc;
	EPawnActionAbortState K2_ForceAbortAction(class UPawnAction* ActionToAbort)	 // 0x70cd6d0;
	bool K2_PushAction(class UPawnAction* NewAction, EAIRequestPriority Priority, class UObject* Instigator)	 // 0x70cd998;
...
public:
	...
	static class UPawnActionsComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPawnAction_Wait* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAIResource_Logic* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBehaviorTree* GetDefaultObj()	 // 0x0
	{
...
public:
	void AddCooldownTagDuration(const struct FGameplayTag& CooldownTag, float CooldownDuration, bool bAddToExistingDuration)	 // 0x70e6264;
	void SetDynamicSubtree(const struct FGameplayTag& InjectTag, class UBehaviorTree* BehaviorAsset)	 // 0x70e96b8;

	double GetTagCooldownEndTime(const struct FGameplayTag& CooldownTag) const	 // 0x70e7844;
...
public:
	...
	static class UBehaviorTreeComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBehaviorTreeManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBehaviorTreeTypes* GetDefaultObj()	 // 0x0
	{
...
{
public:
	class UBlackboardData* GetBlackboardAsset() const	 // 0x57166dc;
...
public:
	...
	static class IBlackboardAssetProvider* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardData* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Bool* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Class* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Enum* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Float* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Int* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Name* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_NativeEnum* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Object* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Rotator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_String* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBlackboardKeyType_Vector* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static void ClearBlackboardValue(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6420;
	static void ClearBlackboardValueAsVector(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6420;
	static class AActor* GetBlackboardValueAsActor(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e65f4;
	static bool GetBlackboardValueAsBool(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6748;
	static class UClass* GetBlackboardValueAsClass(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6898;
	static uint8 GetBlackboardValueAsEnum(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e69e8;
	static float GetBlackboardValueAsFloat(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6b38;
	static int32 GetBlackboardValueAsInt(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6c88;
	static class FName GetBlackboardValueAsName(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6dd8;
	static class UObject* GetBlackboardValueAsObject(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e6f34;
	static struct FRotator GetBlackboardValueAsRotator(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e7070;
	static class FString GetBlackboardValueAsString(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e71ec;
	static struct FVector GetBlackboardValueAsVector(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)	 // 0x70e7340;
	static class UBehaviorTreeComponent* GetOwnerComponent(class UBTNode* NodeOwner)	 // 0x70e75b8;
	static class UBlackboardComponent* GetOwnersBlackboard(class UBTNode* NodeOwner)	 // 0x70e7688;
	static void SetBlackboardValueAsBool(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, bool Value)	 // 0x70e80c8;
	static void SetBlackboardValueAsClass(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, class UClass* Value)	 // 0x70e82fc;
	static void SetBlackboardValueAsEnum(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, uint8 Value)	 // 0x70e851c;
	static void SetBlackboardValueAsFloat(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, float Value)	 // 0x70e874c;
	static void SetBlackboardValueAsInt(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, int32 Value)	 // 0x70e895c;
	static void SetBlackboardValueAsName(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, class FName Value)	 // 0x70e8b8c;
	static void SetBlackboardValueAsObject(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, class UObject* Value)	 // 0x70e8dbc;
	static void SetBlackboardValueAsRotator(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, const struct FRotator& Value)	 // 0x70e8fdc;
	static void SetBlackboardValueAsString(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, const class FString& Value)	 // 0x70e9234;
	static void SetBlackboardValueAsVector(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key, const struct FVector& Value)	 // 0x70e9460;
	static void StartUsingExternalEvent(class UBTNode* NodeOwner, class AActor* OwningActor)	 // 0x4bd0ce8;
	static void StopUsingExternalEvent(class UBTNode* NodeOwner)	 // 0x43f717c;
...
public:
	...
	static class UBTFunctionLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTComposite_Selector* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTComposite_Sequence* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTComposite_SimpleParallel* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_Blackboard* GetDefaultObj()	 // 0x0
	{
...
public:
	bool PerformConditionCheck(class AActor* OwnerActor)	 // 0xae1e64;
	bool PerformConditionCheckAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveExecutionFinish(class AActor* OwnerActor, EBTNodeResult NodeResult)	 // 0xae1e64;
	void ReceiveExecutionFinishAI(class AAIController* OwnerController, class APawn* ControlledPawn, EBTNodeResult NodeResult)	 // 0xae1e64;
	void ReceiveExecutionStart(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveExecutionStartAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveObserverActivated(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveObserverActivatedAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveObserverDeactivated(class AActor* OwnerActor)	 // 0xae1e64;
	void ReceiveObserverDeactivatedAI(class AAIController* OwnerController, class APawn* ControlledPawn)	 // 0xae1e64;
	void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds)	 // 0xae1e64;
	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)	 // 0xae1e64;

	bool IsDecoratorExecutionActive() const	 // 0x70e7f50;
	bool IsDecoratorObserverActive() const	 // 0x70e7fc8;
...
public:
	...
	static class UBTDecorator_BlueprintBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_CheckGameplayTagsOnActor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_CompareBBEntries* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_ConditionalLoop* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_ConeCheck* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_DoesPathExist* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_IsAtLocation* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_IsBBEntryOfClass* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_KeepInCone* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_Loop* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_ReachedMoveGoal* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_SetTagCooldown* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTDecorator_TagCooldown* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTService_DefaultFocus* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_FinishWithResult* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_GameplayTaskBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_MakeNoise* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_MoveTo* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_MoveDirectlyToward* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_PawnActionBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_PlayAnimation* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_PlaySound* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_PushPawnAction* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_RotateToFaceBBEntry* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_RunBehavior* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_RunBehaviorDynamic* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_RunEQSQuery* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_SetTagCooldown* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_Wait* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBTTask_WaitBlackboardTime* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static class UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObject(class UObject* WorldContextObject, class APawn* Pawn, const struct FVector& Destination, class AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap)	 // 0x710efb4;
	static class AAIController* GetAIController(class AActor* ControlledActor)	 // 0x710f468;
	static class UBlackboardComponent* GetBlackboard(class AActor* Target)	 // 0x710f550;
	static class UNavigationPath* GetCurrentPath(class AController* Controller)	 // 0x710f640;
	static int32 GetCurrentPathIndex(const class AController* Controller)	 // 0x710f798;
	static const TArray<struct FVector> GetCurrentPathPoints(class AController* Controller)	 // 0x710f87c;
	static int32 GetNextNavLinkIndex(const class AController* Controller)	 // 0x710fa3c;
	static bool IsValidAIDirection(const struct FVector& DirectionVector)	 // 0x710fe20;
	static bool IsValidAILocation(const struct FVector& Location)	 // 0x710fef0;
	static bool IsValidAIRotation(const struct FRotator& Rotation)	 // 0x7110010;
	static void LockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bLockMovement, bool LockAILogic)	 // 0x71100f8;
	static void SendAIMessage(class APawn* Target, class FName Message, class UObject* MessageSource, bool bSuccess)	 // 0x711072c;
	static void SimpleMoveToActor(class AController* Controller, const class AActor* Goal)	 // 0x7110d90;
	static void SimpleMoveToLocation(class AController* Controller, const struct FVector& Goal)	 // 0x7110ed0;
	static class APawn* SpawnAIFromClass(class UObject* WorldContextObject, TSubclassOf<class APawn> PawnClass, class UBehaviorTree* BehaviorTree, const struct FVector& Location, const struct FRotator& Rotation, bool bNoCollisionFail, class AActor* Owner)	 // 0x7110fd4;
	static void UnlockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bUnlockMovement, bool UnlockAILogic)	 // 0x7111478;
...
public:
	...
	static class UAIBlueprintHelperLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAIDataProvider_Random* GetDefaultObj()	 // 0x0
	{
...
public:
	void ProvideActorsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<class AActor*>* ResultingActorsSet) const	 // 0xae1e64;
	void ProvideLocationsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<struct FVector>* ResultingLocationSet) const	 // 0xae1e64;
	void ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor** ResultingActor) const	 // 0xae1e64;
...
public:
	...
	static class UEnvQueryContext_BlueprintBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryContext_Querier* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQuery* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, EEnvQueryRunMode RunMode, TSubclassOf<class UEnvQueryInstanceBlueprintWrapper> WrapperClass)	 // 0x7110360;
...
public:
	...
	static class UEnvQueryManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryOption* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEQSRenderingComponent* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEQSRenderingComponent) == 0x000630, "Wrong size on UEQSRenderingComponent");
...
public:
	...
	class UEnvQuery*                              QueryTemplate;                                     // 0x0660(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x0668(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	struct FNavAgentProperties                    NavAgentProperties;                                // 0x06A0(0x0038)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	static class AEQSTestingPawn* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_ActorsOfClass* GetDefaultObj()	 // 0x0
	{
...
public:
	void AddGeneratedActor(class AActor* GeneratedActor) const	 // 0x710ece8;
	void AddGeneratedVector(const struct FVector& GeneratedVector) const	 // 0x710eea4;
	void DoItemGeneration(const TArray<struct FVector>& ContextLocations) const	 // 0xae1e64;
	void DoItemGenerationFromActors(const TArray<class AActor*>& ContextActors) const	 // 0xae1e64;
	class UObject* GetQuerier() const	 // 0x710fafc;
...
public:
	...
	static class UEnvQueryGenerator_BlueprintBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_Composite* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_Cone* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_CurrentLocation* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_OnCircle* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_PathingGrid* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryGenerator_PerceivedActors* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryItemType_Direction* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UEnvQueryItemType_Point* GetDefaultObj()	 // 0x0
	{
...
{
public:
	EEnvTestDistance                              TestMode;                                          // 0x0208(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_209[0x7];                                      // 0x0209(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UEnvQueryContext>           DistanceTo;                                        // 0x0210(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	static class UEnvQueryTest_Distance* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Distance) == 0x000218, "Wrong size on UEnvQueryTest_Distance");
static_assert(offsetof(UEnvQueryTest_Distance, TestMode) == 0x000208, "Member 'UEnvQueryTest_Distance::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Distance, DistanceTo) == 0x000210, "Member 'UEnvQueryTest_Distance::DistanceTo' has a wrong offset!");
...
{
public:
	struct FEnvDirection                          LineA;                                             // 0x0208(0x0020)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FEnvDirection                          LineB;                                             // 0x0228(0x0020)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	EEnvTestDot                                   TestMode;                                          // 0x0248(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAbsoluteValue;                                    // 0x0249(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UEnvQueryTest_Dot* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Dot) == 0x000250, "Wrong size on UEnvQueryTest_Dot");
static_assert(offsetof(UEnvQueryTest_Dot, LineA) == 0x000208, "Member 'UEnvQueryTest_Dot::LineA' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, LineB) == 0x000228, "Member 'UEnvQueryTest_Dot::LineB' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, TestMode) == 0x000248, "Member 'UEnvQueryTest_Dot::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, bAbsoluteValue) == 0x000249, "Member 'UEnvQueryTest_Dot::bAbsoluteValue' has a wrong offset!");
...
{
public:
	struct FGameplayTagQuery                      TagQueryToMatch;                                   // 0x0208(0x0048)(Edit, Protected, NativeAccessSpecifierProtected)
	bool                                          bRejectIncompatibleItems;                          // 0x0250(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdatedToUseQuery;                                // 0x0251(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EGameplayContainerMatchType                   TagsToMatch;                                       // 0x0252(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_253[0x5];                                      // 0x0253(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0258(0x0020)(Protected, NativeAccessSpecifierProtected)
...
public:
	...
	static class UEnvQueryTest_GameplayTags* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_GameplayTags) == 0x000278, "Wrong size on UEnvQueryTest_GameplayTags");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagQueryToMatch) == 0x000208, "Member 'UEnvQueryTest_GameplayTags::TagQueryToMatch' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bRejectIncompatibleItems) == 0x000250, "Member 'UEnvQueryTest_GameplayTags::bRejectIncompatibleItems' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bUpdatedToUseQuery) == 0x000251, "Member 'UEnvQueryTest_GameplayTags::bUpdatedToUseQuery' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagsToMatch) == 0x000252, "Member 'UEnvQueryTest_GameplayTags::TagsToMatch' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, GameplayTags) == 0x000258, "Member 'UEnvQueryTest_GameplayTags::GameplayTags' has a wrong offset!");
...
{
public:
	struct FEnvOverlapData                        OverlapData;                                       // 0x0208(0x0030)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	static class UEnvQueryTest_Overlap* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x000238, "Wrong size on UEnvQueryTest_Overlap");
static_assert(offsetof(UEnvQueryTest_Overlap, OverlapData) == 0x000208, "Member 'UEnvQueryTest_Overlap::OverlapData' has a wrong offset!");
...
{
public:
	EEnvTestPathfinding                           TestMode;                                          // 0x0208(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_209[0x7];                                      // 0x0209(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UEnvQueryContext>           Context;                                           // 0x0210(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAIDataProviderBoolValue               PathFromContext;                                   // 0x0218(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderBoolValue               SkipUnreachable;                                   // 0x0250(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x0288(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	static class UEnvQueryTest_Pathfinding* GetDefaultObj()	 // 0x0
	{
...
static_assert(offsetof(UEnvQueryTest_Pathfinding, TestMode) == 0x000208, "Member 'UEnvQueryTest_Pathfinding::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, Context) == 0x000210, "Member 'UEnvQueryTest_Pathfinding::Context' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, PathFromContext) == 0x000218, "Member 'UEnvQueryTest_Pathfinding::PathFromContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, SkipUnreachable) == 0x000250, "Member 'UEnvQueryTest_Pathfinding::SkipUnreachable' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Pathfinding, FilterClass) == 0x000288, "Member 'UEnvQueryTest_Pathfinding::FilterClass' has a wrong offset!");
...
public:
	...
	static class UEnvQueryTest_PathfindingBatch* GetDefaultObj()	 // 0x0
	{
...
{
public:
	struct FEnvTraceData                          ProjectionData;                                    // 0x0208(0x0040)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	static class UEnvQueryTest_Project* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Project) == 0x000248, "Wrong size on UEnvQueryTest_Project");
static_assert(offsetof(UEnvQueryTest_Project, ProjectionData) == 0x000208, "Member 'UEnvQueryTest_Project::ProjectionData' has a wrong offset!");
...
public:
	...
	static class UEnvQueryTest_Random* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Random) == 0x000208, "Wrong size on UEnvQueryTest_Random");
...
{
public:
	struct FEnvTraceData                          TraceData;                                         // 0x0208(0x0040)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct FAIDataProviderBoolValue               TraceFromContext;                                  // 0x0248(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ItemHeightOffset;                                  // 0x0280(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ContextHeightOffset;                               // 0x02B8(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
...
public:
	...
	static class UEnvQueryTest_Trace* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UEnvQueryTest_Trace) == 0x0002F8, "Wrong size on UEnvQueryTest_Trace");
static_assert(offsetof(UEnvQueryTest_Trace, TraceData) == 0x000208, "Member 'UEnvQueryTest_Trace::TraceData' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, TraceFromContext) == 0x000248, "Member 'UEnvQueryTest_Trace::TraceFromContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, ItemHeightOffset) == 0x000280, "Member 'UEnvQueryTest_Trace::ItemHeightOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, ContextHeightOffset) == 0x0002B8, "Member 'UEnvQueryTest_Trace::ContextHeightOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Trace, Context) == 0x0002F0, "Member 'UEnvQueryTest_Trace::Context' has a wrong offset!");
...
public:
	...
	static class AGridPathAIController* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(AGridPathAIController) == 0x0003D8, "Wrong size on AGridPathAIController");
...
public:
	...
	static class UAIHotSpotManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	uint8                                         Pad_110[0x1D8];                                    // 0x0110(0x01D8)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnActorBump(class AActor* SelfActor, class AActor* OtherActor, const struct FVector& NormalImpulse, const struct FHitResult& Hit)	 // 0x712f334;
	void OnNavDataRegistered(class ANavigationData* NavData)	 // 0x712f57c;

	EPathFollowingAction GetPathActionType() const	 // 0x712f020;
	struct FVector GetPathDestination() const	 // 0x712f0a0;
...
public:
	...
	static class UPathFollowingComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	void SuspendCrowdSteering(bool bSuspend)	 // 0x712fe60;
...
public:
	...
	static class UCrowdFollowingComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCrowdManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGridPathFollowingComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UNavFilter_AIControllerDefault* GetDefaultObj()	 // 0x0
	{
...
public:
	static int32 AddLocalNavigationGridForBox(class UObject* WorldContextObject, const struct FVector& Location, const struct FVector& Extent, const struct FRotator& Rotation, const int32 Radius2D, const float Height, bool bRebuildGrids)	 // 0x712dc64;
	static int32 AddLocalNavigationGridForCapsule(class UObject* WorldContextObject, const struct FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, const int32 Radius2D, const float Height, bool bRebuildGrids)	 // 0x712dffc;
	static int32 AddLocalNavigationGridForPoint(class UObject* WorldContextObject, const struct FVector& Location, const int32 Radius2D, const float Height, bool bRebuildGrids)	 // 0x712e370;
	static int32 AddLocalNavigationGridForPoints(class UObject* WorldContextObject, const TArray<struct FVector>& Locations, const int32 Radius2D, const float Height, bool bRebuildGrids)	 // 0x712e5e8;
	static bool FindLocalNavigationGridPath(class UObject* WorldContextObject, const struct FVector& Start, const struct FVector& End, TArray<struct FVector>* PathPoints)	 // 0x712e9a0;
	static void RemoveLocalNavigationGrid(class UObject* WorldContextObject, int32 GridId, bool bRebuildGrids)	 // 0x712f820;
	static bool SetLocalNavigationGridDensity(class UObject* WorldContextObject, float CellSize)	 // 0x712fb18;
...
public:
	...
	static class UNavLocalGridManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPathFollowingManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IAIPerceptionListenerInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISenseConfig_Damage* GetDefaultObj()	 // 0x0
	{
...
public:
	void K2_OnNewPawn(class APawn* NewPawn)	 // 0xae1e64;
	void OnListenerRegistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent)	 // 0xae1e64;
	void OnListenerUnregistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent)	 // 0xae1e64;
	void OnListenerUpdated(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent)	 // 0xae1e64;
	float OnUpdate(const TArray<class UAISenseEvent*>& EventsToProcess)	 // 0xae1e64;

	void GetAllListenerActors(TArray<class AActor*>* ListenerActors) const	 // 0x713c6e0;
	void GetAllListenerComponents(TArray<class UAIPerceptionComponent*>* ListenerComponents) const	 // 0x713c77c;
...
public:
	...
	static class UAISense_Blueprint* GetDefaultObj()	 // 0x0
	{
...
public:
	static void ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, const struct FVector& EventLocation, const struct FVector& HitLocation, class FName Tag, const struct FGameplayTagContainer& GameplayTags)	 // 0x713cd6c;
...
public:
	...
	static class UAISense_Damage* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAISense_Team* GetDefaultObj()	 // 0x0
	{
...
public:
	static void ReportTouchEvent(class UObject* WorldContextObject, class AActor* TouchReceiver, class AActor* OtherActor, const struct FVector& Location)	 // 0x713d890;
...
public:
	...
	static class UAISense_Touch* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IAISightTargetInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetPeripheralVisionAngle(const float NewPeripheralVisionAngle)	 // 0x56671b4;
	void SetSensingInterval(const float NewSensingInterval)	 // 0x713e048;
	void SetSensingUpdatesEnabled(const bool bEnabled)	 // 0x713e110;

	float GetPeripheralVisionAngle() const	 // 0x4a89ab0;
	float GetPeripheralVisionCosine() const	 // 0x57ac4c8;
...
public:
	...
	static class UPawnSensingComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAITask_LockLogic* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAITask_MoveTo* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UAITask_RunEQS* RunEQS(class AAIController* Controller, class UEnvQuery* QueryTemplate)	 // 0x713deac;
...
public:
	...
	static class UAITask_RunEQS* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UVisualLoggerExtension* GetDefaultObj()	 // 0x0
	{

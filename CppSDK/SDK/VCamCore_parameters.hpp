...
static_assert(offsetof(VCamComponent_AddModifier, Name_0) == 0x000000, "Member 'VCamComponent_AddModifier::Name_0' has a wrong offset!");
...
static_assert(sizeof(VCamComponent_GetLiveLinkDataForCurrentFrame) == 0x000150, "Wrong size on VCamComponent_GetLiveLinkDataForCurrentFrame");
...
// Function VCamCore.VCamComponent.HandleObjectReplaced
// 0x0050 (0x0050 - 0x0000)
struct VCamComponent_HandleObjectReplaced final
{
public:
	TMap<class UObject*, class UObject*>          ReplacementMap;                                    // 0x0000(0x0050)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(VCamComponent_HandleObjectReplaced) == 0x000008, "Wrong alignment on VCamComponent_HandleObjectReplaced");
static_assert(sizeof(VCamComponent_HandleObjectReplaced) == 0x000050, "Wrong size on VCamComponent_HandleObjectReplaced");
static_assert(offsetof(VCamComponent_HandleObjectReplaced, ReplacementMap) == 0x000000, "Member 'VCamComponent_HandleObjectReplaced::ReplacementMap' has a wrong offset!");
...
static_assert(offsetof(VCamComponent_InsertModifier, Name_0) == 0x000000, "Member 'VCamComponent_InsertModifier::Name_0' has a wrong offset!");
static_assert(offsetof(VCamComponent_InsertModifier, Index_0) == 0x000008, "Member 'VCamComponent_InsertModifier::Index_0' has a wrong offset!");
...
static_assert(offsetof(VCamComponent_InsertOutputProvider, Index_0) == 0x000000, "Member 'VCamComponent_InsertOutputProvider::Index_0' has a wrong offset!");
...
static_assert(offsetof(VCamComponent_RemoveModifierByName, Name_0) == 0x000000, "Member 'VCamComponent_RemoveModifierByName::Name_0' has a wrong offset!");
...
static_assert(offsetof(VCamComponent_GetModifierByIndex, Index_0) == 0x000000, "Member 'VCamComponent_GetModifierByIndex::Index_0' has a wrong offset!");
...
static_assert(offsetof(VCamComponent_GetModifierByName, Name_0) == 0x000000, "Member 'VCamComponent_GetModifierByName::Name_0' has a wrong offset!");
...
{
public:
	TSubclassOf<class UVCamSubsystem>             Class_0;                                           // 0x0000(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(VCamComponent_GetSubsystemArray, Class_0) == 0x000000, "Member 'VCamComponent_GetSubsystemArray::Class_0' has a wrong offset!");
...
// Function VCamCore.InputVCamSubsystem.SetShouldConsumeGamepadInput
// 0x0001 (0x0001 - 0x0000)
struct InputVCamSubsystem_SetShouldConsumeGamepadInput final
{
public:
	EVCamGamepadInputMode                         GamepadInputMode;                                  // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(InputVCamSubsystem_SetShouldConsumeGamepadInput) == 0x000001, "Wrong alignment on InputVCamSubsystem_SetShouldConsumeGamepadInput");
static_assert(sizeof(InputVCamSubsystem_SetShouldConsumeGamepadInput) == 0x000001, "Wrong size on InputVCamSubsystem_SetShouldConsumeGamepadInput");
static_assert(offsetof(InputVCamSubsystem_SetShouldConsumeGamepadInput, GamepadInputMode) == 0x000000, "Member 'InputVCamSubsystem_SetShouldConsumeGamepadInput::GamepadInputMode' has a wrong offset!");
...
// Function VCamCore.VCamModifierInterface.OnVCamComponentChanged
// 0x0008 (0x0008 - 0x0000)
struct VCamModifierInterface_OnVCamComponentChanged final
{
public:
...
static_assert(alignof(VCamModifierInterface_OnVCamComponentChanged) == 0x000008, "Wrong alignment on VCamModifierInterface_OnVCamComponentChanged");
static_assert(sizeof(VCamModifierInterface_OnVCamComponentChanged) == 0x000008, "Wrong size on VCamModifierInterface_OnVCamComponentChanged");
static_assert(offsetof(VCamModifierInterface_OnVCamComponentChanged, VCam) == 0x000000, "Member 'VCamModifierInterface_OnVCamComponentChanged::VCam' has a wrong offset!");
...
// Function VCamCore.VCamOutputProviderBase.SetTargetCamera
// 0x0008 (0x0008 - 0x0000)
struct VCamOutputProviderBase_SetTargetCamera final
{
public:
	const class UCineCameraComponent*             InTargetCamera;                                    // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(VCamOutputProviderBase_SetTargetCamera) == 0x000008, "Wrong alignment on VCamOutputProviderBase_SetTargetCamera");
static_assert(sizeof(VCamOutputProviderBase_SetTargetCamera) == 0x000008, "Wrong size on VCamOutputProviderBase_SetTargetCamera");
static_assert(offsetof(VCamOutputProviderBase_SetTargetCamera, InTargetCamera) == 0x000000, "Member 'VCamOutputProviderBase_SetTargetCamera::InTargetCamera' has a wrong offset!");
...
{
public:
	struct FVCamChildWidgetReference              WidgetReference;                                   // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	class UUserWidget*                            OwnerWidget;                                       // 0x0030(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UVCamWidget*                            ReturnValue;                                       // 0x0038(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(WidgetReferenceBlueprintFunctionLibrary_ResolveVCamWidget) == 0x000040, "Wrong size on WidgetReferenceBlueprintFunctionLibrary_ResolveVCamWidget");
...
static_assert(offsetof(WidgetReferenceBlueprintFunctionLibrary_ResolveVCamWidget, OwnerWidget) == 0x000030, "Member 'WidgetReferenceBlueprintFunctionLibrary_ResolveVCamWidget::OwnerWidget' has a wrong offset!");
static_assert(offsetof(WidgetReferenceBlueprintFunctionLibrary_ResolveVCamWidget, ReturnValue) == 0x000038, "Member 'WidgetReferenceBlueprintFunctionLibrary_ResolveVCamWidget::ReturnValue' has a wrong offset!");
...
{
public:
	struct FChildWidgetReference                  WidgetReference;                                   // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	class UUserWidget*                            OwnerWidget;                                       // 0x0030(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(WidgetReferenceBlueprintFunctionLibrary_ResolveWidget) == 0x000040, "Wrong size on WidgetReferenceBlueprintFunctionLibrary_ResolveWidget");
...
static_assert(offsetof(WidgetReferenceBlueprintFunctionLibrary_ResolveWidget, OwnerWidget) == 0x000030, "Member 'WidgetReferenceBlueprintFunctionLibrary_ResolveWidget::OwnerWidget' has a wrong offset!");
static_assert(offsetof(WidgetReferenceBlueprintFunctionLibrary_ResolveWidget, ReturnValue) == 0x000038, "Member 'WidgetReferenceBlueprintFunctionLibrary_ResolveWidget::ReturnValue' has a wrong offset!");

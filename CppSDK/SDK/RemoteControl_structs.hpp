...
static_assert(sizeof(FRemoteControlActor) == 0x0000B8, "Wrong size on FRemoteControlActor");
...
public:
	...
	class FName                                   ComponentName;                                     // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SubObjectPath;                                     // 0x0038(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   OwnerActorClass;                                   // 0x0048(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   OwnerActorName;                                    // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FRemoteControlInitialBindingContext) == 0x000080, "Wrong size on FRemoteControlInitialBindingContext");
...
static_assert(offsetof(FRemoteControlInitialBindingContext, SubObjectPath) == 0x000038, "Member 'FRemoteControlInitialBindingContext::SubObjectPath' has a wrong offset!");
static_assert(offsetof(FRemoteControlInitialBindingContext, OwnerActorClass) == 0x000048, "Member 'FRemoteControlInitialBindingContext::OwnerActorClass' has a wrong offset!");
static_assert(offsetof(FRemoteControlInitialBindingContext, OwnerActorName) == 0x000078, "Member 'FRemoteControlInitialBindingContext::OwnerActorName' has a wrong offset!");
...
public:
	...
	struct FSoftClassPath                         OwnerClass;                                        // 0x0110(0x0020)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsEditorOnly;                                     // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         ActiveMasks;                                       // 0x0131(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FRemoteControlField) == 0x000138, "Wrong size on FRemoteControlField");
...
static_assert(offsetof(FRemoteControlField, bIsEditorOnly) == 0x000130, "Member 'FRemoteControlField::bIsEditorOnly' has a wrong offset!");
static_assert(offsetof(FRemoteControlField, ActiveMasks) == 0x000131, "Member 'FRemoteControlField::ActiveMasks' has a wrong offset!");
...
{
public:
	bool                                          bIsEditableInPackaged;                             // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FRemoteControlProperty) == 0x000140, "Wrong size on FRemoteControlProperty");
static_assert(offsetof(FRemoteControlProperty, bIsEditableInPackaged) == 0x000138, "Member 'FRemoteControlProperty::bIsEditableInPackaged' has a wrong offset!");
...
public:
	...
	bool                                          bIsCallableInPackaged;                             // 0x0148(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_149[0x7];                                      // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftObjectPath                        FunctionPath;                                      // 0x0150(0x0020)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FRemoteControlFunction) == 0x000178, "Wrong size on FRemoteControlFunction");
static_assert(offsetof(FRemoteControlFunction, bIsCallableInPackaged) == 0x000148, "Member 'FRemoteControlFunction::bIsCallableInPackaged' has a wrong offset!");
static_assert(offsetof(FRemoteControlFunction, FunctionPath) == 0x000150, "Member 'FRemoteControlFunction::FunctionPath' has a wrong offset!");
...
{
public:
	TSubclassOf<class UObject>                    OriginalClass;                                     // 0x0140(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMaterialParameterInfo                 ParameterInfo;                                     // 0x0148(0x0010)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRCFieldPathInfo                       OriginalFieldPathInfo;                             // 0x0158(0x0018)(NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        InstancePath;                                      // 0x0170(0x0020)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRemoteControlInstanceMaterial) == 0x000008, "Wrong alignment on FRemoteControlInstanceMaterial");
static_assert(sizeof(FRemoteControlInstanceMaterial) == 0x000190, "Wrong size on FRemoteControlInstanceMaterial");
static_assert(offsetof(FRemoteControlInstanceMaterial, OriginalClass) == 0x000140, "Member 'FRemoteControlInstanceMaterial::OriginalClass' has a wrong offset!");
static_assert(offsetof(FRemoteControlInstanceMaterial, ParameterInfo) == 0x000148, "Member 'FRemoteControlInstanceMaterial::ParameterInfo' has a wrong offset!");
static_assert(offsetof(FRemoteControlInstanceMaterial, OriginalFieldPathInfo) == 0x000158, "Member 'FRemoteControlInstanceMaterial::OriginalFieldPathInfo' has a wrong offset!");
static_assert(offsetof(FRemoteControlInstanceMaterial, InstancePath) == 0x000170, "Member 'FRemoteControlInstanceMaterial::InstancePath' has a wrong offset!");
...
static_assert(sizeof(FRemoteControlPresetGroup) == 0x000038, "Wrong size on FRemoteControlPresetGroup");
...
static_assert(offsetof(FRemoteControlPresetGroup, TagColor) == 0x000018, "Member 'FRemoteControlPresetGroup::TagColor' has a wrong offset!");
static_assert(offsetof(FRemoteControlPresetGroup, Fields) == 0x000028, "Member 'FRemoteControlPresetGroup::Fields' has a wrong offset!");

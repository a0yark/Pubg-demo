...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A5092B0;
	constexpr int32 AppendString      = 0x00C90114;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x0A5140F0;
	constexpr int32 ProcessEvent      = 0x00AE0BE0;
...
public:
	inline int32 Num() const	 // 0x0
	{
		return NumElements;
	}
	
	FUObjectItem** GetDecrytedObjPtr() const	 // 0x0
	{
		return reinterpret_cast<FUObjectItem**>(DecryptPtr(Objects));
	}
	
	inline class UObject* GetByIndex(const int32 Index) const	 // 0x0
	{
...
public:
	static void InitInternal()	 // 0x0
	{
		AppendString = reinterpret_cast<void*>(InSDKUtils::GetImageBase() + Offsets::AppendString);
	}
	static void InitManually(void* Location)	 // 0x0
	{
		AppendString = reinterpret_cast<void*>(Location);
	}

	int32 GetDisplayIndex() const	 // 0x0
	{
		return ComparisonIndex;
	}
	
	std::string GetRawString() const	 // 0x0
	{
	...
	bool operator==(const FName& Other) const	 // 0x0
	{
...
public:
	const class FString& GetStringRef() const	 // 0x0
	{
...
public:
	class UObject* Get() const	 // 0x0;
	class UObject* operator->() const	 // 0x0;
	bool operator==(const FWeakObjectPtr& Other) const	 // 0x0;
	bool operator!=(const FWeakObjectPtr& Other) const	 // 0x0;
	bool operator==(const class UObject* Other) const	 // 0x0;
	bool operator!=(const class UObject* Other) const	 // 0x0;
};
...
public:
	class UObject* GetObjectRef() const	 // 0x0
	{
		return ObjectPointer;
	}
	
	void* GetInterfaceRef() const	 // 0x0
	{

...
public:
	...
	TSubclassOf<class UAISense>                   ReturnValue;                                       // 0x0088(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AIPerceptionSystem_GetSenseClassForStimulus) == 0x000090, "Wrong size on AIPerceptionSystem_GetSenseClassForStimulus");
...
static_assert(offsetof(AIPerceptionSystem_GetSenseClassForStimulus, ReturnValue) == 0x000088, "Member 'AIPerceptionSystem_GetSenseClassForStimulus::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AISense_Hearing_ReportNoiseEvent) == 0x000060, "Wrong size on AISense_Hearing_ReportNoiseEvent");
...
static_assert(offsetof(AISense_Hearing_ReportNoiseEvent, GameplayTags) == 0x000040, "Member 'AISense_Hearing_ReportNoiseEvent::GameplayTags' has a wrong offset!");
...
public:
	...
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0058(0x0020)(Parm, NativeAccessSpecifierPublic)
};
static_assert(alignof(AISense_Damage_ReportDamageEvent) == 0x000008, "Wrong alignment on AISense_Damage_ReportDamageEvent");
static_assert(sizeof(AISense_Damage_ReportDamageEvent) == 0x000078, "Wrong size on AISense_Damage_ReportDamageEvent");
...
static_assert(offsetof(AISense_Damage_ReportDamageEvent, GameplayTags) == 0x000058, "Member 'AISense_Damage_ReportDamageEvent::GameplayTags' has a wrong offset!");

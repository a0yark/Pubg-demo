...
public:
	...
	static class UChaosDebugDrawComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosEventListenerComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	TMap<class UPrimitiveComponent*, struct FCrumblingEventCallbackWrapper> CrumblingEventRegistrations; // 0x02C8(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
public:
	...
	static class UChaosGameplayEventDispatcher* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UChaosGameplayEventDispatcher) == 0x000328, "Wrong size on UChaosGameplayEventDispatcher");
...
static_assert(offsetof(UChaosGameplayEventDispatcher, RemovalEventRegistrations) == 0x000278, "Member 'UChaosGameplayEventDispatcher::RemovalEventRegistrations' has a wrong offset!");
static_assert(offsetof(UChaosGameplayEventDispatcher, CrumblingEventRegistrations) == 0x0002C8, "Member 'UChaosGameplayEventDispatcher::CrumblingEventRegistrations' has a wrong offset!");
...
public:
	...
	static class IChaosNotifyHandlerInterface* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static struct FHitResult ConvertPhysicsCollisionToHitResult(const struct FChaosPhysicsCollisionInfo& PhysicsCollision)	 // 0x650b134;
...
public:
	...
	static class UChaosSolverEngineBlueprintLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosSolver* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UChaosSolverSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetAsCurrentWorldSolver()	 // 0x650b250;
	void SetSolverActive(bool bActive)	 // 0x4061c8c;
...
public:
	...
	static class AChaosSolverActor* GetDefaultObj()	 // 0x0
	{
...
static_assert(offsetof(AChaosSolverActor, bHasFloor) == 0x00036C, "Member 'AChaosSolverActor::bHasFloor' has a wrong offset!");

...
static_assert(offsetof(FWwiseInitBankCookedData, Media) == 0x000020, "Member 'FWwiseInitBankCookedData::Media' has a wrong offset!");
static_assert(offsetof(FWwiseInitBankCookedData, Language) == 0x000030, "Member 'FWwiseInitBankCookedData::Language' has a wrong offset!");

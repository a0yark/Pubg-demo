...
public:
	class URootMotionModifier* AddRootMotionModifier(class UMotionWarpingComponent* MotionWarpingComp, const class UAnimSequenceBase* Animation, float StartTime, float EndTime) const	 // 0x16b1f78;
	void OnRootMotionModifierActivate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier) const	 // 0x1712b6c;
	void OnRootMotionModifierDeactivate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier) const	 // 0x1713700;
	void OnRootMotionModifierUpdate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier) const	 // 0x16c6320;
	void OnWarpBegin(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier) const	 // 0xae1e64;
	void OnWarpEnd(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier) const	 // 0xae1e64;
	void OnWarpUpdate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier) const	 // 0xae1e64;
...
public:
	...
	static class UAnimNotifyState_MotionWarping* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static struct FTransform ExtractRootMotionFromAnimation(const class UAnimSequenceBase* Animation, float StartTime, float EndTime)	 // 0x4314fc8;
	static void GetMotionWarpingWindowsForWarpTargetFromAnimation(const class UAnimSequenceBase* Animation, class FName WarpTargetName, TArray<struct FMotionWarpingWindowData>* OutWindows)	 // 0x43151c0;
	static void GetMotionWarpingWindowsFromAnimation(const class UAnimSequenceBase* Animation, TArray<struct FMotionWarpingWindowData>* OutWindows)	 // 0x43154d4;
...
public:
	...
	static class UMotionWarpingUtilities* GetDefaultObj()	 // 0x0
	{
...
public:
	void AddOrUpdateWarpTarget(const struct FMotionWarpingTarget& WarpTarget)	 // 0x4313984;
	void AddOrUpdateWarpTargetFromComponent(class FName WarpTargetName, const class USceneComponent* Component, class FName BoneName, bool bFollowComponent)	 // 0x4313a58;
	void AddOrUpdateWarpTargetFromLocation(class FName WarpTargetName, const struct FVector& TargetLocation)	 // 0x4313de0;
	void AddOrUpdateWarpTargetFromLocationAndRotation(class FName WarpTargetName, const struct FVector& TargetLocation, const struct FRotator& TargetRotation)	 // 0x4313f34;
	void AddOrUpdateWarpTargetFromTransform(class FName WarpTargetName, const struct FTransform& TargetTransform)	 // 0x4314124;
	void DisableAllRootMotionModifiers()	 // 0x4314f74;
	int32 RemoveWarpTarget(class FName WarpTargetName)	 // 0x43156f4;
...
public:
	...
	static class UMotionWarpingComponent* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UMotionWarpingComponent) == 0x000100, "Wrong size on UMotionWarpingComponent");
...
public:
	...
	static class URootMotionModifier* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URootMotionModifier_Warp* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URootMotionModifier_AdjustmentBlendWarp* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URootMotionModifier_SimpleWarp* GetDefaultObj()	 // 0x0
	{
...
public:
	static class URootMotionModifier_Scale* AddRootMotionModifierScale(class UMotionWarpingComponent* InMotionWarpingComp, const class UAnimSequenceBase* InAnimation, float InStartTime, float InEndTime, const struct FVector& InScale)	 // 0x4314308;
...
public:
	...
	static class URootMotionModifier_Scale* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URootMotionModifier_SkewWarp* GetDefaultObj()	 // 0x0
	{

...
void UAISense_Hearing::ReportNoiseEvent(class UObject* WorldContextObject, const struct FVector& NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, class FName Tag, const struct FGameplayTagContainer& GameplayTags)
{
	static class UFunction* Func = nullptr;
...
void UAISense_Damage::ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, const struct FVector& EventLocation, const struct FVector& HitLocation, class FName Tag, const struct FGameplayTagContainer& GameplayTags)
{
	static class UFunction* Func = nullptr;

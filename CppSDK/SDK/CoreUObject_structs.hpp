...
public:
	FVector& Normalize()	 // 0x0
	{
		*this /= Magnitude();
		return *this;
	}
	FVector& operator*=(const FVector& Other)	 // 0x0
	{
		*this = *this * Other;
		return *this;
	}
	FVector& operator*=(float Scalar)	 // 0x0
	{
		*this = *this * Scalar;
		return *this;
	}
	...
	UnderlayingType Dot(const FVector& Other) const	 // 0x0
	{
		return (X * Other.X) + (Y * Other.Y) + (Z * Other.Z);
	}
	UnderlayingType GetDistanceTo(const FVector& Other) const	 // 0x0
	{
		FVector DiffVector = Other - *this;
		return DiffVector.Magnitude();
	}
	UnderlayingType GetDistanceToInMeters(const FVector& Other) const	 // 0x0
	{
		return GetDistanceTo(Other) * static_cast<UnderlayingType>(0.01);
	}
	FVector GetNormalized() const	 // 0x0
	{
		return *this / Magnitude();
	}
	bool IsZero() const	 // 0x0
	{
		return X == 0.0 && Y == 0.0 && Z == 0.0;
	}
	UnderlayingType Magnitude() const	 // 0x0
	{
		return std::sqrt((X * X) + (Y * Y) + (Z * Z));
	}
	bool operator!=(const FVector& Other) const	 // 0x0
	{
		return X != Other.X || Y != Other.Y || Z != Other.Z;
	}
	FVector operator*(const FVector& Other) const	 // 0x0
	{
		return { X * Other.X, Y * Other.Y, Z * Other.Z };
	}
	FVector operator*(float Scalar) const	 // 0x0
	{
...
public:
	FVector2D& Normalize()	 // 0x0
	{
		*this /= Magnitude();
		return *this;
	}
	FVector2D& operator*=(const FVector2D& Other)	 // 0x0
	{
		*this = *this * Other;
		return *this;
	}
	FVector2D& operator*=(float Scalar)	 // 0x0
	{
		*this = *this * Scalar;
		return *this;
	}
	...
	UnderlayingType Dot(const FVector2D& Other) const	 // 0x0
	{
		return (X * Other.X) + (Y * Other.Y);
	}
	UnderlayingType GetDistanceTo(const FVector2D& Other) const	 // 0x0
	{
		FVector2D DiffVector = Other - *this;
		return DiffVector.Magnitude();
	}
	FVector2D GetNormalized() const	 // 0x0
	{
		return *this / Magnitude();
	}
	bool IsZero() const	 // 0x0
	...
	bool operator!=(const FVector2D& Other) const	 // 0x0
	{
		return X != Other.X || Y != Other.Y;
	}
	FVector2D operator*(const FVector2D& Other) const	 // 0x0
	{
		return { X * Other.X, Y * Other.Y };
	}
	FVector2D operator*(float Scalar) const	 // 0x0
	{

...
public:
	void AddGlobalCamera(class AActor* InActor)	 // 0x43f717c;
	void AddTargetObject(class AActor* InActor)	 // 0x52b1658;
	void RemoveGlobalCamera(class AActor* InActor)	 // 0x43f717c;
	void RemoveTargetObject(class AActor* InActor)	 // 0x52b1840;
	void SetMipLevelDistance(float Distance)	 // 0x52b19c4;
	void SetSequencePath(const class FString& Path)	 // 0x52b1a6c;
	void SetTokenizedSequencePath(const class FString& Path)	 // 0x52b1b3c;

	void GetProxies(TArray<class FString>* OutProxies) const	 // 0x52b172c;
	const class FString GetSequencePath() const	 // 0x52b17f0;
...
public:
	...
	static class UImgMediaSource* GetDefaultObj()	 // 0x0
	{

...
public:
	...
	static class ULiveLinkComponentSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkControllerBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkLightController* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULiveLinkTransformController* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	TMap<TSubclassOf<class ULiveLinkRole>, class ULiveLinkControllerBase*> ControllerMap;            // 0x00D0(0x0050)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, NoClear, Interp, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	void SetSubjectRepresentation(const struct FLiveLinkSubjectRepresentation& InSubjectRepresentation)	 // 0x503cc38;

	struct FLiveLinkSubjectRepresentation GetSubjectRepresentation() const	 // 0x4ff7644;
...
public:
	...
	static class ULiveLinkComponentController* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(ULiveLinkComponentController) == 0x000168, "Wrong size on ULiveLinkComponentController");
...
static_assert(offsetof(ULiveLinkComponentController, ControllerMap) == 0x0000D0, "Member 'ULiveLinkComponentController::ControllerMap' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bUpdateInEditor) == 0x000120, "Member 'ULiveLinkComponentController::bUpdateInEditor' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, OnLiveLinkUpdated) == 0x000128, "Member 'ULiveLinkComponentController::OnLiveLinkUpdated' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, OnControllerMapUpdatedDelegate) == 0x000138, "Member 'ULiveLinkComponentController::OnControllerMapUpdatedDelegate' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bDisableEvaluateLiveLinkWhenSpawnable) == 0x000148, "Member 'ULiveLinkComponentController::bDisableEvaluateLiveLinkWhenSpawnable' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bEvaluateLiveLink) == 0x000149, "Member 'ULiveLinkComponentController::bEvaluateLiveLink' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bUpdateInPreviewEditor) == 0x00014A, "Member 'ULiveLinkComponentController::bUpdateInPreviewEditor' has a wrong offset!");

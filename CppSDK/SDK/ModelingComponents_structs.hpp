...
public:
	...
	class UObject*                                TypeHintObject;                                    // 0x0018(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TypeHintExtended;                                  // 0x0020(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWorld*                                 TargetWorld;                                       // 0x0028(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FCreateMeshObjectParams, TypeHintObject) == 0x000018, "Member 'FCreateMeshObjectParams::TypeHintObject' has a wrong offset!");
static_assert(offsetof(FCreateMeshObjectParams, TypeHintExtended) == 0x000020, "Member 'FCreateMeshObjectParams::TypeHintExtended' has a wrong offset!");
static_assert(offsetof(FCreateMeshObjectParams, TargetWorld) == 0x000028, "Member 'FCreateMeshObjectParams::TargetWorld' has a wrong offset!");

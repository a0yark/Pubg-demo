...
public:
	...
	static class UAudioSynesthesiaSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAudioSynesthesiaNRTSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULoudnessNRTSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAudioSynesthesiaNRT* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UConstantQNRTSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	void GetChannelConstantQAtTime(const float InSeconds, const int32 InChannel, TArray<float>* OutConstantQ) const	 // 0x55a390c;
	void GetNormalizedChannelConstantQAtTime(const float InSeconds, const int32 InChannel, TArray<float>* OutConstantQ) const	 // 0x55a3fb8;
...
public:
	...
	static class UConstantQNRT* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULoudnessSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULoudnessAnalyzer* GetDefaultObj()	 // 0x0
	{
...
public:
	void GetChannelLoudnessAtTime(const float InSeconds, const int32 InChannel, float* OutLoudness) const	 // 0x55a3aac;
	void GetLoudnessAtTime(const float InSeconds, float* OutLoudness) const	 // 0x55a3eac;
	void GetNormalizedChannelLoudnessAtTime(const float InSeconds, const int32 InChannel, float* OutLoudness) const	 // 0x55a4158;
	void GetNormalizedLoudnessAtTime(const float InSeconds, float* OutLoudness) const	 // 0x55a4558;
...
public:
	...
	static class ULoudnessNRT* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMeterSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMeterAnalyzer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UOnsetNRTSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	void GetChannelOnsetsBetweenTimes(const float InStartSeconds, const float InEndSeconds, const int32 InChannel, TArray<float>* OutOnsetTimestamps, TArray<float>* OutOnsetStrengths) const	 // 0x55a3c34;
	void GetNormalizedChannelOnsetsBetweenTimes(const float InStartSeconds, const float InEndSeconds, const int32 InChannel, TArray<float>* OutOnsetTimestamps, TArray<float>* OutOnsetStrengths) const	 // 0x55a42e0;
...
public:
	...
	static class UOnsetNRT* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class USynesthesiaSpectrumAnalysisSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	void GetCenterFrequencies(const float InSampleRate, TArray<float>* OutCenterFrequencies)	 // 0x55a37dc;

	const int32 GetNumCenterFrequencies() const	 // 0x55a4664;
...
public:
	...
	static class USynesthesiaSpectrumAnalyzer* GetDefaultObj()	 // 0x0
	{

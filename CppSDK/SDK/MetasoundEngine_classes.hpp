...
public:
	static class UMetasoundGeneratorHandle* CreateMetaSoundGeneratorHandle(class UAudioComponent* OnComponent)	 // 0x5582dc8;

	bool ApplyParameterPack(class UMetasoundParameterPack* Pack)	 // 0x5582bbc;
...
public:
	...
	static class UMetasoundGeneratorHandle* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetaSoundSource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetaSoundSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetasoundEditorGraphBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetaSoundPatch* GetDefaultObj()	 // 0x0
	{
...
public:
	void RegisterAssetClassesInDirectories(const TArray<struct FMetaSoundAssetDirectory>& Directories)	 // 0x5582eb8;
	void UnregisterAssetClassesInDirectories(const TArray<struct FMetaSoundAssetDirectory>& Directories)	 // 0x5582f50;
...
public:
	...
	static class UMetaSoundAssetSubsystem* GetDefaultObj()	 // 0x0
	{

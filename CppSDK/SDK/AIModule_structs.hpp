...
public:
	...
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0048(0x0020)(BlueprintVisible, NativeAccessSpecifierPublic)
	int32                                         Count;                                             // 0x0068(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bSuccessfullySensed : 1;                           // 0x0078(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIStimulus) == 0x000008, "Wrong alignment on FAIStimulus");
static_assert(sizeof(FAIStimulus) == 0x000080, "Wrong size on FAIStimulus");
...
static_assert(offsetof(FAIStimulus, GameplayTags) == 0x000048, "Member 'FAIStimulus::GameplayTags' has a wrong offset!");
static_assert(offsetof(FAIStimulus, Count) == 0x000068, "Member 'FAIStimulus::Count' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIStimulus                            Stimulus;                                          // 0x0010(0x0080)(BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FActorPerceptionUpdateInfo) == 0x000008, "Wrong alignment on FActorPerceptionUpdateInfo");
static_assert(sizeof(FActorPerceptionUpdateInfo) == 0x000090, "Wrong size on FActorPerceptionUpdateInfo");
...
public:
	...
	int32                                         Count;                                             // 0x0058(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAINoiseEvent) == 0x000008, "Wrong alignment on FAINoiseEvent");
static_assert(sizeof(FAINoiseEvent) == 0x000060, "Wrong size on FAINoiseEvent");
...
static_assert(offsetof(FAINoiseEvent, GameplayTags) == 0x000038, "Member 'FAINoiseEvent::GameplayTags' has a wrong offset!");
static_assert(offsetof(FAINoiseEvent, Count) == 0x000058, "Member 'FAINoiseEvent::Count' has a wrong offset!");
...
static_assert(sizeof(FAIDamageEvent) == 0x000070, "Wrong size on FAIDamageEvent");
...
static_assert(offsetof(FAIDamageEvent, GameplayTags) == 0x000050, "Member 'FAIDamageEvent::GameplayTags' has a wrong offset!");

...
public:
	...
	static class UActorSequence* GetDefaultObj()	 // 0x0
	{
...
{
public:
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x00C0(0x0020)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	void PauseSequence()	 // 0x52cfbd4;
	void PlaySequence()	 // 0x52cfbfc;
	void StopSequence()	 // 0x52cfc24;
...
public:
	...
	static class UActorSequenceComponent* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UActorSequenceComponent) == 0x0000F0, "Wrong size on UActorSequenceComponent");
...
static_assert(offsetof(UActorSequenceComponent, Sequence) == 0x0000E0, "Member 'UActorSequenceComponent::Sequence' has a wrong offset!");
static_assert(offsetof(UActorSequenceComponent, SequencePlayer) == 0x0000E8, "Member 'UActorSequenceComponent::SequencePlayer' has a wrong offset!");
...
public:
	...
	static class UActorSequencePlayer* GetDefaultObj()	 // 0x0
	{

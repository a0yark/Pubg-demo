...
static_assert(sizeof(FGeometryScriptCopyMeshToAssetOptions) == 0x000078, "Wrong size on FGeometryScriptCopyMeshToAssetOptions");
...
static_assert(offsetof(FGeometryScriptCopyMeshToAssetOptions, bEmitTransaction) == 0x000070, "Member 'FGeometryScriptCopyMeshToAssetOptions::bEmitTransaction' has a wrong offset!");
static_assert(offsetof(FGeometryScriptCopyMeshToAssetOptions, bDeferMeshPostEditChange) == 0x000071, "Member 'FGeometryScriptCopyMeshToAssetOptions::bDeferMeshPostEditChange' has a wrong offset!");

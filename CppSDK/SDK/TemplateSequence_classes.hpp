...
public:
	...
	static class UTemplateSequence* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCameraAnimationEntitySystemLinker* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCameraAnimationSequence* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCameraAnimationSequenceSubsystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	struct FPostProcessSettings                   PostProcessSettings;                               // 0x0040(0x0740)(NativeAccessSpecifierPublic)
	float                                         PostProcessBlendWeight;                            // 0x0780(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FCameraFilmbackSettings                Filmback;                                          // 0x0784(0x000C)(NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraLensSettings                    LensSettings;                                      // 0x0790(0x001C)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_7AC[0x4];                                      // 0x07AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x07B0(0x0068)(NativeAccessSpecifierPublic)
	float                                         CurrentFocalLength;                                // 0x0818(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurrentAperture;                                   // 0x081C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurrentFocusDistance;                              // 0x0820(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	static class UCameraAnimationSequenceCameraStandIn* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UCameraAnimationSequenceCameraStandIn) == 0x0008A0, "Wrong size on UCameraAnimationSequenceCameraStandIn");
...
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, PostProcessBlendWeight) == 0x000780, "Member 'UCameraAnimationSequenceCameraStandIn::PostProcessBlendWeight' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, Filmback) == 0x000784, "Member 'UCameraAnimationSequenceCameraStandIn::Filmback' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, LensSettings) == 0x000790, "Member 'UCameraAnimationSequenceCameraStandIn::LensSettings' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, FocusSettings) == 0x0007B0, "Member 'UCameraAnimationSequenceCameraStandIn::FocusSettings' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentFocalLength) == 0x000818, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentAperture) == 0x00081C, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentFocusDistance) == 0x000820, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentFocusDistance' has a wrong offset!");
...
public:
	...
	static class UCameraAnimationSequencePlayer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCameraAnimationSpawnableSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCameraAnimationBoundObjectInstantiator* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTemplateSequenceSection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class USequenceCameraShakePattern* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTemplateSequenceSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTemplateSequencePropertyScalingInstantiatorSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTemplateSequencePropertyScalingEvaluatorSystem* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetBinding(class AActor* Actor, bool bOverridesDefault)	 // 0x515d260;
	void SetSequence(class UTemplateSequence* InSequence)	 // 0x515d468;

	class UTemplateSequence* GetSequence() const	 // 0x515d1ec;
	class UTemplateSequencePlayer* GetSequencePlayer() const	 // 0x515d210;
	class UTemplateSequence* LoadSequence() const	 // 0x515d23c;
...
public:
	...
	static class ATemplateSequenceActor* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UTemplateSequencePlayer* CreateTemplateSequencePlayer(class UObject* WorldContextObject, class UTemplateSequence* TemplateSequence, const struct FMovieSceneSequencePlaybackSettings& Settings, class ATemplateSequenceActor** OutActor)	 // 0x515c9a8;
...
public:
	...
	static class UTemplateSequencePlayer* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static struct FMinimalViewInfo GetCameraCachePOV(class APlayerController* PlayerController)	 // 0x515cd3c;
	static struct FMinimalViewInfo GetLastFrameCameraCachePOV(class APlayerController* PlayerController)	 // 0x515ce54;
	static bool GetPostProcessBlendCache(class APlayerController* PlayerController, int32 PPIndex, struct FPostProcessSettings* OutPPSettings, float* OutPPBlendWeight)	 // 0x515cf6c;
...
public:
	...
	static class USequenceCameraShakeTestUtil* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTemplateSequenceTrack* GetDefaultObj()	 // 0x0
	{

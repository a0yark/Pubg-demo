...
public:
	...
	struct FGameplayTag                           InputTag;                                          // 0x0034(0x0008)(Edit, DisableEditOnInstance, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TWeakObjectPtr<class UObject>                 SourceObject;                                      // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayAbilitySpecDef, InputTag) == 0x000034, "Member 'FGameplayAbilitySpecDef::InputTag' has a wrong offset!");
...
public:
	...
	struct FInstancedStruct                       CustomPayload;                                     // 0x00D0(0x0010)(BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bReplicateLocationWhenUsingMinimalRepProxy;        // 0x00E0(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayCueParameters, CustomPayload) == 0x0000D0, "Member 'FGameplayCueParameters::CustomPayload' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, bReplicateLocationWhenUsingMinimalRepProxy) == 0x0000E0, "Member 'FGameplayCueParameters::bReplicateLocationWhenUsingMinimalRepProxy' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 Parameters;                                        // 0x0030(0x00F0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bPredictivelyRemoved;                              // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FActiveGameplayCue) == 0x000128, "Wrong size on FActiveGameplayCue");
...
static_assert(offsetof(FActiveGameplayCue, bPredictivelyRemoved) == 0x000120, "Member 'FActiveGameplayCue::bPredictivelyRemoved' has a wrong offset!");

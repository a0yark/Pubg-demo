...
{
public:
	static void Bink_DrawOverlays()	 // 0x50fa304;
	static struct FTimespan BinkLoadingMovie_GetDuration()	 // 0x50fa2ac;
	static struct FTimespan BinkLoadingMovie_GetTime()	 // 0x50fa2d8;
...
public:
	...
	static class UBinkFunctionLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	void CloseUrl()	 // 0x50fa390;
	void Draw(class UTexture* Texture, bool tonemap, int32 out_nits, float ALPHA, bool srgb_decode, bool hdr)	 // 0x50fa3e4;
	bool OpenUrl(const class FString& NewUrl)	 // 0x50fa82c;
	bool Pause()	 // 0x50fa968;
	bool Play()	 // 0x50fa990;
	bool Rewind()	 // 0x50fa9bc;
	bool Seek(const struct FTimespan& InTime)	 // 0x50fa9ec;
	bool SetLooping(bool InLooping)	 // 0x50faa84;
	bool SetRate(float Rate)	 // 0x50fac1c;
	void SetVolume(float Rate)	 // 0x50facec;
	void Stop()	 // 0x50fadd0;

	bool CanPause() const	 // 0x50fa318;
	bool CanPlay() const	 // 0x50fa33c;
	struct FTimespan GetDuration() const	 // 0x50fa72c;
	float GetRate() const	 // 0x50fa758;
	struct FTimespan GetTime() const	 // 0x50fa780;
	class FString GetUrl() const	 // 0x50fa7ac;
	bool IsInitialized() const	 // 0x50fa33c;
	bool IsLooping() const	 // 0x50fa7c8;
	bool IsPaused() const	 // 0x50fa7ec;
	bool IsPlaying() const	 // 0x50fa318;
	bool IsStopped() const	 // 0x50fa810;
	bool SupportsRate(float Rate, bool Unthinned) const	 // 0x50fade4;
	bool SupportsScrubbing() const	 // 0x16463d4;
	bool SupportsSeeking() const	 // 0x16463d4;
...
public:
	...
	static class UBinkMediaPlayer* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	uint8                                         Pad_1E5[0x1B];                                     // 0x01E5(0x001B)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void Clear()	 // 0x50fa358;
	void SetMediaPlayer(class UBinkMediaPlayer* InMediaPlayer)	 // 0x50fab54;
...
public:
	...
	static class UBinkMediaTexture* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBinkMoviePlayerSettings* GetDefaultObj()	 // 0x0
	{

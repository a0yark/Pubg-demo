...
public:
	...
	class FName                                   TypePath;                                          // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ContainerType;                                     // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 KeyType;                                           // 0x0060(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRCPropertyDescription) == 0x0000C0, "Wrong size on FRCPropertyDescription");
...
static_assert(offsetof(FRCPropertyDescription, ContainerType) == 0x000050, "Member 'FRCPropertyDescription::ContainerType' has a wrong offset!");
static_assert(offsetof(FRCPropertyDescription, KeyType) == 0x000060, "Member 'FRCPropertyDescription::KeyType' has a wrong offset!");
static_assert(offsetof(FRCPropertyDescription, MetaData) == 0x000070, "Member 'FRCPropertyDescription::MetaData' has a wrong offset!");
...
public:
	...
	struct FRCPropertyDescription                 UnderlyingProperty;                                // 0x0018(0x00C0)(NativeAccessSpecifierPublic)
	TMap<class FName, class FString>              MetaData;                                          // 0x00D8(0x0050)(NativeAccessSpecifierPublic)
	TArray<struct FRCObjectDescription>           OwnerObjects;                                      // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRCExposedPropertyDescription) == 0x000008, "Wrong alignment on FRCExposedPropertyDescription");
static_assert(sizeof(FRCExposedPropertyDescription) == 0x000138, "Wrong size on FRCExposedPropertyDescription");
...
static_assert(offsetof(FRCExposedPropertyDescription, MetaData) == 0x0000D8, "Member 'FRCExposedPropertyDescription::MetaData' has a wrong offset!");
static_assert(offsetof(FRCExposedPropertyDescription, OwnerObjects) == 0x000128, "Member 'FRCExposedPropertyDescription::OwnerObjects' has a wrong offset!");
...
public:
	...
	class FString                                 Path;                                              // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, class FString>              MetaData;                                          // 0x0038(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FRCControllerDescription) == 0x000008, "Wrong alignment on FRCControllerDescription");
static_assert(sizeof(FRCControllerDescription) == 0x000088, "Wrong size on FRCControllerDescription");
...
static_assert(offsetof(FRCControllerDescription, ID) == 0x000008, "Member 'FRCControllerDescription::ID' has a wrong offset!");
static_assert(offsetof(FRCControllerDescription, Type) == 0x000018, "Member 'FRCControllerDescription::Type' has a wrong offset!");
static_assert(offsetof(FRCControllerDescription, Path) == 0x000028, "Member 'FRCControllerDescription::Path' has a wrong offset!");
static_assert(offsetof(FRCControllerDescription, MetaData) == 0x000038, "Member 'FRCControllerDescription::MetaData' has a wrong offset!");
...
static_assert(offsetof(FRCRequestWrapper, RequestID) == 0x000090, "Member 'FRCRequestWrapper::RequestID' has a wrong offset!");
...
static_assert(sizeof(FRCWebSocketActorRegisterBody) == 0x000080, "Wrong size on FRCWebSocketActorRegisterBody");
...
static_assert(sizeof(FRCWebSocketPresetSetPropertyBody) == 0x0000A0, "Wrong size on FRCWebSocketPresetSetPropertyBody");
...
static_assert(offsetof(FRCWebSocketPresetSetPropertyBody, PropertyLabel) == 0x000080, "Member 'FRCWebSocketPresetSetPropertyBody::PropertyLabel' has a wrong offset!");
static_assert(offsetof(FRCWebSocketPresetSetPropertyBody, Operation) == 0x000088, "Member 'FRCWebSocketPresetSetPropertyBody::Operation' has a wrong offset!");
static_assert(offsetof(FRCWebSocketPresetSetPropertyBody, TransactionMode) == 0x000089, "Member 'FRCWebSocketPresetSetPropertyBody::TransactionMode' has a wrong offset!");
static_assert(offsetof(FRCWebSocketPresetSetPropertyBody, TransactionId) == 0x00008C, "Member 'FRCWebSocketPresetSetPropertyBody::TransactionId' has a wrong offset!");
static_assert(offsetof(FRCWebSocketPresetSetPropertyBody, ResetToDefault) == 0x000090, "Member 'FRCWebSocketPresetSetPropertyBody::ResetToDefault' has a wrong offset!");
static_assert(offsetof(FRCWebSocketPresetSetPropertyBody, SequenceNumber) == 0x000098, "Member 'FRCWebSocketPresetSetPropertyBody::SequenceNumber' has a wrong offset!");
...
static_assert(sizeof(FRCPresetFieldsAddedEvent) == 0x000078, "Wrong size on FRCPresetFieldsAddedEvent");
...
static_assert(sizeof(FRCPresetControllersRenamedEvent) == 0x000038, "Wrong size on FRCPresetControllersRenamedEvent");
...
static_assert(offsetof(FRCPresetControllersRenamedEvent, PresetId) == 0x000018, "Member 'FRCPresetControllersRenamedEvent::PresetId' has a wrong offset!");
static_assert(offsetof(FRCPresetControllersRenamedEvent, RenamedControllers) == 0x000028, "Member 'FRCPresetControllersRenamedEvent::RenamedControllers' has a wrong offset!");
...
static_assert(sizeof(FRCPresetControllersRemovedEvent) == 0x000048, "Wrong size on FRCPresetControllersRemovedEvent");
...
static_assert(offsetof(FRCPresetControllersRemovedEvent, PresetId) == 0x000018, "Member 'FRCPresetControllersRemovedEvent::PresetId' has a wrong offset!");
static_assert(offsetof(FRCPresetControllersRemovedEvent, RemovedControllers) == 0x000028, "Member 'FRCPresetControllersRemovedEvent::RemovedControllers' has a wrong offset!");
static_assert(offsetof(FRCPresetControllersRemovedEvent, RemovedControllerIds) == 0x000038, "Member 'FRCPresetControllersRemovedEvent::RemovedControllerIds' has a wrong offset!");
...
static_assert(sizeof(FRCPresetControllersAddedEvent) == 0x000078, "Wrong size on FRCPresetControllersAddedEvent");
...
static_assert(offsetof(FRCPresetControllersAddedEvent, PresetId) == 0x000018, "Member 'FRCPresetControllersAddedEvent::PresetId' has a wrong offset!");
static_assert(offsetof(FRCPresetControllersAddedEvent, Description) == 0x000028, "Member 'FRCPresetControllersAddedEvent::Description' has a wrong offset!");
...
static_assert(sizeof(FRCPresetControllersModifiedEvent) == 0x000048, "Wrong size on FRCPresetControllersModifiedEvent");
...
static_assert(offsetof(FRCPresetControllersModifiedEvent, PresetId) == 0x000018, "Member 'FRCPresetControllersModifiedEvent::PresetId' has a wrong offset!");
static_assert(offsetof(FRCPresetControllersModifiedEvent, ModifiedControllers) == 0x000028, "Member 'FRCPresetControllersModifiedEvent::ModifiedControllers' has a wrong offset!");

...
static_assert(offsetof(CineSplineComponent_GetPointRotationAtSplinePoint, Index_0) == 0x000000, "Member 'CineSplineComponent_GetPointRotationAtSplinePoint::Index_0' has a wrong offset!");

...
public:
	class UEnum* GetAnimationStateEnum()	 // 0x516e7b4;
	void ProcessActorState(int32* OutState, class AActor* InActor, uint8 CurrentState, uint8 OnDemandState, bool* bShouldProcess)	 // 0x516e878;
...
public:
	...
	static class UAnimationSharingStateProcessor* GetDefaultObj()	 // 0x0
	{
...
public:
	void GetInstancedActors(TArray<class AActor*>* Actors)	 // 0x516e7dc;
...
public:
	...
	static class UAnimSharingStateInstance* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAnimSharingTransitionInstance* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAnimSharingAdditiveInstance* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAnimSharingInstance* GetDefaultObj()	 // 0x0
	{
...
public:
	static bool AnimationSharingEnabled()	 // 0x516e40c;
	static bool CreateAnimationSharingManager(class UObject* WorldContextObject, const class UAnimationSharingSetup* Setup)	 // 0x516e428;
	static class UAnimationSharingManager* GetAnimationSharingManager(class UObject* WorldContextObject)	 // 0x516e694;

	void RegisterActorWithSkeletonBP(class AActor* InActor, const class USkeleton* SharingSkeleton)	 // 0x516eaac;
...
public:
	...
	static class UAnimationSharingManager* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAnimationSharingSetup* GetDefaultObj()	 // 0x0
	{

...
public:
	...
	static class UNamedInterfaces* GetDefaultObj()	 // 0x0
	{
...
{
public:
	void OnMatchEnded(const class FString& Match)	 // 0xae1e64;
	void OnMatchReceivedTurn(const class FString& Match, bool bDidBecomeActive)	 // 0xae1e64;
...
public:
	...
	static class ITurnBasedMatchInterface* GetDefaultObj()	 // 0x0
	{

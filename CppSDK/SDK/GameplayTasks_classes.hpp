...
public:
	void EndTask()	 // 0xa33388;
	void ReadyForActivation()	 // 0x1756484;
...
public:
	...
	static class UGameplayTask* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGameplayTask_TimeLimitedExecution* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static class UGameplayTask_ClaimResource* ClaimResource(TScriptInterface<class IGameplayTaskOwnerInterface> InTaskOwner, TSubclassOf<class UGameplayTaskResource> ResourceClass, const uint8 Priority, const class FName TaskInstanceName)	 // 0x6fc5294;
	static class UGameplayTask_ClaimResource* ClaimResources(TScriptInterface<class IGameplayTaskOwnerInterface> InTaskOwner, const TArray<TSubclassOf<class UGameplayTaskResource>>& ResourceClasses, const uint8 Priority, const class FName TaskInstanceName)	 // 0x6fc54e0;
...
public:
	...
	static class UGameplayTask_ClaimResource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	uint8                                         BitPad_D4_0 : 1;                                   // 0x00D4(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bIsNetDirty : 1;                                   // 0x00D4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	static class UGameplayTasksComponent* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IGameplayTaskOwnerInterface* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGameplayTaskResource* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class AActor> Class_0, bool bSpawnOnlyOnAuthority)	 // 0x6fc5c44;

	bool BeginSpawningActor(class UObject* WorldContextObject, class AActor** SpawnedActor)	 // 0x6fc5174;
	void FinishSpawningActor(class UObject* WorldContextObject, class AActor* SpawnedActor)	 // 0x6fc57a4;
...
public:
	...
	static class UGameplayTask_SpawnActor* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UGameplayTask_WaitDelay* TaskWaitDelay(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, float Time, const uint8 Priority)	 // 0x6fc5f28;
...
public:
	...
	static class UGameplayTask_WaitDelay* GetDefaultObj()	 // 0x0
	{

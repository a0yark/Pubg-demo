...
static_assert(sizeof(FConcertAdmin_SessionInfoResponse) == 0x000118, "Wrong size on FConcertAdmin_SessionInfoResponse");
...
static_assert(sizeof(FConcertAdmin_BatchDeleteSessionResponse) == 0x000080, "Wrong size on FConcertAdmin_BatchDeleteSessionResponse");
static_assert(offsetof(FConcertAdmin_BatchDeleteSessionResponse, DeletedItems) == 0x000060, "Member 'FConcertAdmin_BatchDeleteSessionResponse::DeletedItems' has a wrong offset!");
static_assert(offsetof(FConcertAdmin_BatchDeleteSessionResponse, NotOwnedByClient) == 0x000070, "Member 'FConcertAdmin_BatchDeleteSessionResponse::NotOwnedByClient' has a wrong offset!");

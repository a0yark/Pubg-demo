...
// Function GameplayDebugger.GameplayDebuggerCategoryReplicator.OnRep_OwnerPC
// (Final, Native, Protected)

void AGameplayDebuggerCategoryReplicator::OnRep_OwnerPC()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayDebuggerCategoryReplicator", "OnRep_OwnerPC");

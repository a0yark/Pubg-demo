...
public:
	...
	static class UGeometryCache* GetDefaultObj()	 // 0x0
	{
...
public:
	class UGeometryCacheComponent* GetGeometryCacheComponent() const	 // 0x17d5724;
...
public:
	...
	static class AGeometryCacheActor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGeometryCacheCodecBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGeometryCacheCodecRaw* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGeometryCacheCodecV1* GetDefaultObj()	 // 0x0
	{
...
{
public:
	class UGeometryCache*                         GeometryCache;                                     // 0x05E0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRunning;                                          // 0x05E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bLooping;                                          // 0x05E9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bExtrapolateFrames;                                // 0x05EA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_5EB[0x1];                                      // 0x05EB(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StartTimeOffset;                                   // 0x05EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PlaybackSpeed;                                     // 0x05F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MotionVectorScale;                                 // 0x05F4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumTracks;                                         // 0x05F8(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         ElapsedTime;                                       // 0x05FC(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_600[0x4C];                                     // 0x0600(0x004C)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Duration;                                          // 0x064C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bManualTick;                                       // 0x0650(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bOverrideWireframeColor;                           // 0x0651(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_652[0x2];                                      // 0x0652(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           WireframeOverrideColor;                            // 0x0654(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_664[0xC];                                      // 0x0664(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void Pause()	 // 0x529bdbc;
	void Play()	 // 0x529bddc;
	void PlayFromStart()	 // 0x143a730;
	void PlayReversed()	 // 0x529be20;
	void PlayReversedFromEnd()	 // 0x529be64;
	void SetExtrapolateFrames(const bool bNewExtrapolating)	 // 0x529beb4;
	bool SetGeometryCache(class UGeometryCache* NewGeomCache)	 // 0x529bf74;
	void SetLooping(const bool bNewLooping)	 // 0x529c044;
	void SetMotionVectorScale(const float NewMotionVectorScale)	 // 0x529c1bc;
	void SetOverrideWireframeColor(bool bOverride)	 // 0x529c290;
	void SetPlaybackSpeed(const float NewPlaybackSpeed)	 // 0x17f12b4;
	void SetStartTimeOffset(const float NewStartTimeOffset)	 // 0x17210dc;
	void SetWireframeOverrideColor(const struct FLinearColor& Color)	 // 0x529c350;
	void Stop()	 // 0x529c40c;
	void TickAtThisTime(const float Time, bool bInIsRunning, bool bInBackwards, bool bInIsLooping)	 // 0x529c424;

	float GetAnimationTime() const	 // 0x143abcc;
	float GetDuration() const	 // 0x16acd14;
	float GetMotionVectorScale() const	 // 0x529bc84;
	int32 GetNumberOfFrames() const	 // 0x143ae50;
	bool GetOverrideWireframeColor() const	 // 0x529bcb0;
	float GetPlaybackDirection() const	 // 0x529bcc8;
	float GetPlaybackSpeed() const	 // 0x529bce0;
	float GetStartTimeOffset() const	 // 0x529bd0c;
	struct FLinearColor GetWireframeOverrideColor() const	 // 0x529bd24;
	bool IsExtrapolatingFrames() const	 // 0x529bd40;
	bool IsLooping() const	 // 0x529bd58;
	bool IsPlaying() const	 // 0x529bd70;
	bool IsPlayingReversed() const	 // 0x529bd88;
...
public:
	...
	static class UGeometryCacheComponent* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UGeometryCacheComponent) == 0x000670, "Wrong size on UGeometryCacheComponent");
static_assert(offsetof(UGeometryCacheComponent, GeometryCache) == 0x0005E0, "Member 'UGeometryCacheComponent::GeometryCache' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bRunning) == 0x0005E8, "Member 'UGeometryCacheComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bLooping) == 0x0005E9, "Member 'UGeometryCacheComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bExtrapolateFrames) == 0x0005EA, "Member 'UGeometryCacheComponent::bExtrapolateFrames' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, StartTimeOffset) == 0x0005EC, "Member 'UGeometryCacheComponent::StartTimeOffset' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, PlaybackSpeed) == 0x0005F0, "Member 'UGeometryCacheComponent::PlaybackSpeed' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, MotionVectorScale) == 0x0005F4, "Member 'UGeometryCacheComponent::MotionVectorScale' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, NumTracks) == 0x0005F8, "Member 'UGeometryCacheComponent::NumTracks' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, ElapsedTime) == 0x0005FC, "Member 'UGeometryCacheComponent::ElapsedTime' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, Duration) == 0x00064C, "Member 'UGeometryCacheComponent::Duration' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bManualTick) == 0x000650, "Member 'UGeometryCacheComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bOverrideWireframeColor) == 0x000651, "Member 'UGeometryCacheComponent::bOverrideWireframeColor' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, WireframeOverrideColor) == 0x000654, "Member 'UGeometryCacheComponent::WireframeOverrideColor' has a wrong offset!");
...
public:
	...
	static class UGeometryCacheTrack* GetDefaultObj()	 // 0x0
	{
...
public:
	void AddMeshSample(const struct FGeometryCacheMeshData& MeshData, const float SampleTime)	 // 0x529bae8;
...
public:
	...
	static class UGeometryCacheTrack_FlipbookAnimation* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGeometryCacheTrackStreamable* GetDefaultObj()	 // 0x0
	{
...
public:
	void SetMesh(const struct FGeometryCacheMeshData& NewMeshData)	 // 0x529c104;
...
public:
	...
	static class UGeometryCacheTrack_TransformAnimation* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGeometryCacheTrack_TransformGroupAnimation* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UNiagaraGeometryCacheRendererProperties* GetDefaultObj()	 // 0x0
	{

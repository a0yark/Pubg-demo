...
public:
	...
	static class UReplicationGraphNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_ActorListFrequencyBuckets* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UNetReplicationGraphConnection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_AlwaysRelevant* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_ActorList* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_ConnectionDormancyNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraph* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UBasicReplicationGraph* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_DynamicSpatialFrequency* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_DormancyNode* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_GridCell* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_GridSpatialization2D* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_AlwaysRelevant_ForConnection* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UReplicationGraphNode_TearOff_ForConnection* GetDefaultObj()	 // 0x0
	{
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x02B8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	void ClientCellInfo(const struct FVector& CellLocation, const struct FVector& CellExtent, const TArray<class AActor*>& Actors)	 // 0x4d692f0;
	void ServerCellInfo()	 // 0x1555670;
	void ServerPrintAllActorInfo(const class FString& Str)	 // 0x4d69500;
	void ServerPrintCullDistances()	 // 0x4d695d4;
	void ServerSetConditionalActorBreakpoint(class AActor* Actor)	 // 0x4c4df3c;
	void ServerSetCullDistanceForClass(class UClass* Class_0, float CullDistance)	 // 0x4d695ec;
	void ServerSetPeriodFrameForClass(class UClass* Class_0, int32 PeriodFrame)	 // 0x4d69730;
	void ServerStartDebugging()	 // 0x1765068;
	void ServerStopDebugging()	 // 0x4d69874;
...
public:
	...
	static class AReplicationGraphDebugActor* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x0002C0, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x0002B0, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x0002B8, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");

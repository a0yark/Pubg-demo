...
{
public:
	void OnOutputFrameStarted(class UMoviePipeline* ForPipeline)	 // 0xae1e64;
...
public:
	...
	static class UMoviePipelineBurnInWidget* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMoviePipelineBurnInSetting* GetDefaultObj()	 // 0x0
	{
...
public:
	bool AddConsoleVariable(const class FString& Name_0, const float Value)	 // 0x4f2fe90;
	bool AddOrUpdateConsoleVariable(const class FString& Name_0, const float Value)	 // 0x4f30000;
	bool RemoveConsoleVariable(const class FString& Name_0, const bool bRemoveAllInstances)	 // 0x4f30264;
	bool UpdateConsoleVariableEnableState(const class FString& Name_0, const bool bIsEnabled)	 // 0x4f303d4;

	TArray<struct FMoviePipelineConsoleVariableEntry> GetConsoleVariables() const	 // 0x4f30170;
...
public:
	...
	static class UMoviePipelineConsoleVariableSetting* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMoviePipelineWidgetRenderer* GetDefaultObj()	 // 0x0
	{

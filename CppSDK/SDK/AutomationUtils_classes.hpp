...
{
public:
	static void TakeGameplayAutomationScreenshot(const class FString& ScreenshotName, float MaxGlobalError, float MaxLocalError, const class FString& MapNameOverride)	 // 0x51b837c;
...
public:
	...
	static class UAutomationUtilsBlueprintLibrary* GetDefaultObj()	 // 0x0
	{

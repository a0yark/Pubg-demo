...
#include "WwiseSoundEngine_structs.hpp"
...
// 0x0001 (0x0001 - 0x0000)
struct AkComponent_SetAutoDestroy final
{
public:
	bool                                          in_AutoDestroy;                                    // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AkComponent_SetAutoDestroy) == 0x000001, "Wrong alignment on AkComponent_SetAutoDestroy");
static_assert(sizeof(AkComponent_SetAutoDestroy) == 0x000001, "Wrong size on AkComponent_SetAutoDestroy");
static_assert(offsetof(AkComponent_SetAutoDestroy, in_AutoDestroy) == 0x000000, "Member 'AkComponent_SetAutoDestroy::in_AutoDestroy' has a wrong offset!");
...
// Function AkAudio.AkComponent.SetIsSubComponent
// 0x0001 (0x0001 - 0x0000)
struct AkComponent_SetIsSubComponent final
{
public:
	bool                                          in_IsSubComponent;                                 // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AkComponent_SetIsSubComponent) == 0x000001, "Wrong alignment on AkComponent_SetIsSubComponent");
static_assert(sizeof(AkComponent_SetIsSubComponent) == 0x000001, "Wrong size on AkComponent_SetIsSubComponent");
static_assert(offsetof(AkComponent_SetIsSubComponent, in_IsSubComponent) == 0x000000, "Member 'AkComponent_SetIsSubComponent::in_IsSubComponent' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct AkComponent_GetCurrentRoom final
{
public:
	class UAkRoomComponent*                       ReturnValue;                                       // 0x0000(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AkComponent_GetCurrentRoom) == 0x000008, "Wrong alignment on AkComponent_GetCurrentRoom");
static_assert(sizeof(AkComponent_GetCurrentRoom) == 0x000008, "Wrong size on AkComponent_GetCurrentRoom");
static_assert(offsetof(AkComponent_GetCurrentRoom, ReturnValue) == 0x000000, "Member 'AkComponent_GetCurrentRoom::ReturnValue' has a wrong offset!");

// Function AkAudio.AkComponent.GetIndoorRoomSize
// 0x0004 (0x0004 - 0x0000)
struct AkComponent_GetIndoorRoomSize final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AkComponent_GetIndoorRoomSize) == 0x000004, "Wrong alignment on AkComponent_GetIndoorRoomSize");
static_assert(sizeof(AkComponent_GetIndoorRoomSize) == 0x000004, "Wrong size on AkComponent_GetIndoorRoomSize");
static_assert(offsetof(AkComponent_GetIndoorRoomSize, ReturnValue) == 0x000000, "Member 'AkComponent_GetIndoorRoomSize::ReturnValue' has a wrong offset!");

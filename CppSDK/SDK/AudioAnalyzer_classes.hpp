...
public:
	...
	static class UAudioAnalyzerAssetBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAudioAnalyzerSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAudioAnalyzerNRTSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAudioAnalyzerNRT* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UAudioAnalyzerSubsystem* GetDefaultObj()	 // 0x0
	{
...
public:
	void StartAnalyzing(const class UObject* WorldContextObject, class UAudioBus* AudioBusToAnalyze)	 // 0x720a138;
	void StopAnalyzing(const class UObject* WorldContextObject)	 // 0x720a49c;
...
public:
	...
	static class UAudioAnalyzer* GetDefaultObj()	 // 0x0
	{

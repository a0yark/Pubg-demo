...
public:
	...
	EPoseSearchPostSearchStatus                   PostSearchStatus;                                  // 0x0010(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPoseSearchDatabaseSetEntry) == 0x000008, "Wrong alignment on FPoseSearchDatabaseSetEntry");
static_assert(sizeof(FPoseSearchDatabaseSetEntry) == 0x000018, "Wrong size on FPoseSearchDatabaseSetEntry");
...
static_assert(offsetof(FPoseSearchDatabaseSetEntry, PostSearchStatus) == 0x000010, "Member 'FPoseSearchDatabaseSetEntry::PostSearchStatus' has a wrong offset!");
...
public:
	...
	int32                                         ColorPresetIndex;                                  // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchBone) == 0x000004, "Wrong alignment on FPoseSearchBone");
static_assert(sizeof(FPoseSearchBone) == 0x00001C, "Wrong size on FPoseSearchBone");
...
static_assert(offsetof(FPoseSearchBone, ColorPresetIndex) == 0x000018, "Member 'FPoseSearchBone::ColorPresetIndex' has a wrong offset!");
...
public:
	...
	int32                                         AssetIndex;                                        // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseSearchPoseMetadata) == 0x000004, "Wrong alignment on FPoseSearchPoseMetadata");
static_assert(sizeof(FPoseSearchPoseMetadata) == 0x000010, "Wrong size on FPoseSearchPoseMetadata");
...
static_assert(offsetof(FPoseSearchPoseMetadata, AssetIndex) == 0x00000C, "Member 'FPoseSearchPoseMetadata::AssetIndex' has a wrong offset!");
...
public:
	...
	TArray<struct FPoseSearchPoseMetadata>        PoseMetadata;                                      // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	EPoseSearchPoseFlags                          OverallFlags;                                      // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPoseSearchIndexAsset>          assets;                                            // 0x0030(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         MinCostAddend;                                     // 0x0040(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPoseSearchIndexBase) == 0x000008, "Wrong alignment on FPoseSearchIndexBase");
static_assert(sizeof(FPoseSearchIndexBase) == 0x000048, "Wrong size on FPoseSearchIndexBase");
static_assert(offsetof(FPoseSearchIndexBase, NumPoses) == 0x000000, "Member 'FPoseSearchIndexBase::NumPoses' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndexBase, Values) == 0x000008, "Member 'FPoseSearchIndexBase::Values' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndexBase, PoseMetadata) == 0x000018, "Member 'FPoseSearchIndexBase::PoseMetadata' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndexBase, OverallFlags) == 0x000028, "Member 'FPoseSearchIndexBase::OverallFlags' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndexBase, assets) == 0x000030, "Member 'FPoseSearchIndexBase::assets' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndexBase, MinCostAddend) == 0x000040, "Member 'FPoseSearchIndexBase::MinCostAddend' has a wrong offset!");

// ScriptStruct PoseSearch.PoseSearchIndex
// 0x0058 (0x00A0 - 0x0048)
struct FPoseSearchIndex final : public FPoseSearchIndexBase
{
public:
	TArray<float>                                 PCAValues;                                         // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 PCAProjectionMatrix;                               // 0x0058(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<float>                                 Mean;                                              // 0x0068(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<float>                                 WeightsSqrt;                                       // 0x0078(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FPoseSearchIndex, PCAValues) == 0x000048, "Member 'FPoseSearchIndex::PCAValues' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndex, PCAProjectionMatrix) == 0x000058, "Member 'FPoseSearchIndex::PCAProjectionMatrix' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndex, Mean) == 0x000068, "Member 'FPoseSearchIndex::Mean' has a wrong offset!");
static_assert(offsetof(FPoseSearchIndex, WeightsSqrt) == 0x000078, "Member 'FPoseSearchIndex::WeightsSqrt' has a wrong offset!");
...
static_assert(sizeof(FPoseSearchAnimPlayer) == 0x0001B8, "Wrong size on FPoseSearchAnimPlayer");
...
public:
	...
	float                                         PlayRateMin;                                       // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayRateMax;                                       // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMotionMatchingSettings) == 0x000008, "Wrong alignment on FMotionMatchingSettings");
static_assert(sizeof(FMotionMatchingSettings) == 0x000030, "Wrong size on FMotionMatchingSettings");
...
static_assert(offsetof(FMotionMatchingSettings, PlayRateMin) == 0x000024, "Member 'FMotionMatchingSettings::PlayRateMin' has a wrong offset!");
static_assert(offsetof(FMotionMatchingSettings, PlayRateMax) == 0x000028, "Member 'FMotionMatchingSettings::PlayRateMax' has a wrong offset!");
...
public:
	...
	struct FTrajectorySampleRange                 Trajectory;                                        // 0x0070(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMotionMatchingSettings                Settings;                                          // 0x0080(0x0030)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_MotionMatching, Settings) == 0x000080, "Member 'FAnimNode_MotionMatching::Settings' has a wrong offset!");
...
public:
	...
	float                                         ElapsedPoseJumpTime;                               // 0x0040(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WantedPlayRate;                                    // 0x0044(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMotionMatchingFlags                          Flags;                                             // 0x0048(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FMotionMatchingState, ElapsedPoseJumpTime) == 0x000040, "Member 'FMotionMatchingState::ElapsedPoseJumpTime' has a wrong offset!");
static_assert(offsetof(FMotionMatchingState, WantedPlayRate) == 0x000044, "Member 'FMotionMatchingState::WantedPlayRate' has a wrong offset!");
static_assert(offsetof(FMotionMatchingState, Flags) == 0x000048, "Member 'FMotionMatchingState::Flags' has a wrong offset!");

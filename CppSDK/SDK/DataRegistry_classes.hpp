...
public:
	...
	static class UDataRegistrySource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UDataRegistrySource_DataTable* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UDataRegistry* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetaDataRegistrySource* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetaDataRegistrySource_DataTable* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UDataRegistrySettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UDataRegistrySource_CurveTable* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMetaDataRegistrySource_CurveTable* GetDefaultObj()	 // 0x0
	{
...
public:
	static bool AcquireItemBP(const struct FDataRegistryId& ItemId, TDelegate<void(const struct FDataRegistryId& ItemId, const struct FDataRegistryLookup& ResolvedLookup, EDataRegistryAcquireStatus Status)> AcquireCallback)	 // 0x3d3a8c0;
	static class FString Conv_DataRegistryIdToString(const struct FDataRegistryId& DataRegistryId)	 // 0x3d3aa2c;
	static class FString Conv_DataRegistryTypeToString(const struct FDataRegistryType& DataRegistryType)	 // 0x3d3ab1c;
	static bool EqualEqual_DataRegistryId(const struct FDataRegistryId& A, const struct FDataRegistryId& B)	 // 0x3d3ac00;
	static bool EqualEqual_DataRegistryType(const struct FDataRegistryType& A, const struct FDataRegistryType& B)	 // 0x3d3ad60;
	static void EvaluateDataRegistryCurve(const struct FDataRegistryId& ItemId, float InputValue, float DefaultValue, EDataRegistrySubsystemGetItemResult* OutResult, float* OutValue)	 // 0x3d3aea0;
	static void FindCachedItemBP(const struct FDataRegistryId& ItemId, EDataRegistrySubsystemGetItemResult* OutResult, struct FTableRowBase* OutItem)	 // 0x3d3b154;
	static bool GetCachedItemBP(const struct FDataRegistryId& ItemId, struct FTableRowBase& OutItem)	 // 0x3d3b3f8;
	static bool GetCachedItemFromLookupBP(const struct FDataRegistryId& ItemId, const struct FDataRegistryLookup& ResolvedLookup, struct FTableRowBase* OutItem)	 // 0x3d3b5f8;
	static bool IsValidDataRegistryId(const struct FDataRegistryId& DataRegistryId)	 // 0x3d3b914;
	static bool IsValidDataRegistryType(const struct FDataRegistryType& DataRegistryType)	 // 0x3d3b9e4;
	static bool NotEqual_DataRegistryId(const struct FDataRegistryId& A, const struct FDataRegistryId& B)	 // 0x3d3bab4;
	static bool NotEqual_DataRegistryType(const struct FDataRegistryType& A, const struct FDataRegistryType& B)	 // 0x3d3bc14;
...
public:
	...
	static class UDataRegistrySubsystem* GetDefaultObj()	 // 0x0
	{

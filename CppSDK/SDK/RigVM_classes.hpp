...
public:
	...
	static class URigVMMemoryStorage* GetDefaultObj()	 // 0x0
	{
...
public:
	void ReportError(const class FString& InMessage)	 // 0x7046ef4;
	void ReportInfo(const class FString& InMessage)	 // 0x7046fcc;
	void ReportWarning(const class FString& InMessage)	 // 0x70470a4;

	bool IsValid() const	 // 0x7046ed8;
	bool RequiresDialog() const	 // 0x704717c;
...
public:
	...
	static class URigVMUserWorkflowOptions* GetDefaultObj()	 // 0x0
	{
...
public:
	static TArray<class URigVMHost*> FindRigVMHosts(class UObject* Outer_0, TSubclassOf<class URigVMHost> OptionalClass)	 // 0x704d6f8;

	bool Execute(const class FName& InEventName)	 // 0x704d5c0;
	bool ExecuteEvent(const class FName& InEventName)	 // 0x704d660;
	class URigVM* GetVM()	 // 0x704db10;
	bool RemoveRunOnceEvent(const class FName& InEventName)	 // 0x704dc98;
	void RequestInit()	 // 0x3dd0a64;
	void RequestRunOnceEvent(const class FName& InEventName, int32 InEventIndex)	 // 0x704dd30;
	void SetAbsoluteAndDeltaTime(float InAbsoluteTime, float InDeltaTime)	 // 0x704de3c;
	void SetAbsoluteTime(float InAbsoluteTime, bool InSetDeltaTimeZero)	 // 0x704df7c;
	void SetDeltaTime(float InDeltaTime)	 // 0x704e0bc;
	void SetFramesPerSecond(float InFramesPerSecond)	 // 0x704e17c;
	bool SetVariableFromString(const class FName& InVariableName, const class FString& InValue)	 // 0x704e23c;

	bool CanExecute() const	 // 0x6836d24;
	float GetAbsoluteTime() const	 // 0x4f99320;
	float GetCurrentFramesPerSecond() const	 // 0x704da10;
	float GetDeltaTime() const	 // 0x4eea7a4;
	TArray<class FName> GetScriptAccessibleVariables() const	 // 0x704da30;
	const TArray<class FName> GetSupportedEvents() const	 // 0x704da70;
	class FString GetVariableAsString(const class FName& InVariableName) const	 // 0x704db34;
	class FName GetVariableType(const class FName& InVariableName) const	 // 0x704dbd4;
	bool SupportsEvent(const class FName& InEventName) const	 // 0x704e34c;
...
public:
	...
	static class URigVMHost* GetDefaultObj()	 // 0x0
	{
...
public:
	int32 AddRigVMFunction(class UScriptStruct* InRigVMStruct, const class FName& InMethodName)	 // 0x6fd7c60;
	bool Execute(const class FName& InEntryName)	 // 0x6fd7d80;
	bool GetParameterValueBool(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd7e20;
	double GetParameterValueDouble(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd7f40;
	float GetParameterValueFloat(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd8060;
	int32 GetParameterValueInt(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd8180;
	class FName GetParameterValueName(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd82a0;
	struct FQuat GetParameterValueQuat(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd83cc;
	class FString GetParameterValueString(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd8518;
	struct FTransform GetParameterValueTransform(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd8660;
	struct FVector GetParameterValueVector(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd893c;
	struct FVector2D GetParameterValueVector2D(const class FName& InParameterName, int32 InArrayIndex)	 // 0x6fd8804;
	void SetParameterValueBool(const class FName& InParameterName, bool InValue, int32 InArrayIndex)	 // 0x6fd8bbc;
	void SetParameterValueDouble(const class FName& InParameterName, double InValue, int32 InArrayIndex)	 // 0x6fd8d58;
	void SetParameterValueFloat(const class FName& InParameterName, float InValue, int32 InArrayIndex)	 // 0x6fd8efc;
	void SetParameterValueInt(const class FName& InParameterName, int32 InValue, int32 InArrayIndex)	 // 0x6fd909c;
	void SetParameterValueName(const class FName& InParameterName, const class FName& InValue, int32 InArrayIndex)	 // 0x6fd9238;
	void SetParameterValueQuat(const class FName& InParameterName, const struct FQuat& InValue, int32 InArrayIndex)	 // 0x6fd9398;
	void SetParameterValueString(const class FName& InParameterName, const class FString& InValue, int32 InArrayIndex)	 // 0x6fd9554;
	void SetParameterValueTransform(const class FName& InParameterName, const struct FTransform& InValue, int32 InArrayIndex)	 // 0x6fd9700;
	void SetParameterValueVector(const class FName& InParameterName, const struct FVector& InValue, int32 InArrayIndex)	 // 0x6fd9a84;
	void SetParameterValueVector2D(const class FName& InParameterName, const struct FVector2D& InValue, int32 InArrayIndex)	 // 0x6fd98c8;

	class FString GetRigVMFunctionName(int32 InFunctionIndex) const	 // 0x6fd8a8c;
	struct FRigVMStatistics GetStatistics() const	 // 0x6fd8b74;
...
public:
	...
	static class URigVM* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URigVMBlueprintGeneratedClass* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class IRigVMGraphFunctionHost* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URigVMMemoryStorageGeneratorClass* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class URigVMNativized* GetDefaultObj()	 // 0x0
	{

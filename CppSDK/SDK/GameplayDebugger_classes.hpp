...
{
public:
	class APlayerController*                      OwnerPC;                                           // 0x02B0(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UGameplayDebuggerRenderingComponent*    RenderingComp;                                     // 0x0300(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_308[0x68];                                     // 0x0308(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ClientDataPackPacket(const struct FGameplayDebuggerDataPackRPCParams& Params_0)	 // 0x71b488c;
	void OnRep_OwnerPC()	 // 0x71b4980;
	void OnRep_ReplicatedData()	 // 0x71b49a4;
	void ServerResetViewPoint()	 // 0x71b49e4;
	void ServerSendCategoryInputEvent(int32 CategoryId, int32 HandlerId)	 // 0x71b4a30;
	void ServerSendExtensionInputEvent(int32 ExtensionId, int32 HandlerId)	 // 0x71b4ba4;
	void ServerSetCategoryEnabled(int32 CategoryId, bool bEnable)	 // 0x71b4d18;
	void ServerSetDebugActor(class AActor* Actor, bool bSelectInEditor)	 // 0x71b4e90;
	void ServerSetEnabled(bool bEnable)	 // 0x71b500c;
	void ServerSetViewPoint(const struct FVector& InViewLocation, const struct FVector& InViewDirection)	 // 0x71b50fc;
...
public:
	...
	static class AGameplayDebuggerCategoryReplicator* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(AGameplayDebuggerCategoryReplicator) == 0x000370, "Wrong size on AGameplayDebuggerCategoryReplicator");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, OwnerPC) == 0x0002B0, "Member 'AGameplayDebuggerCategoryReplicator::OwnerPC' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, bIsEnabled) == 0x0002B8, "Member 'AGameplayDebuggerCategoryReplicator::bIsEnabled' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, ReplicatedData) == 0x0002C0, "Member 'AGameplayDebuggerCategoryReplicator::ReplicatedData' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, DebugActor) == 0x0002D8, "Member 'AGameplayDebuggerCategoryReplicator::DebugActor' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, VisLogSync) == 0x0002F0, "Member 'AGameplayDebuggerCategoryReplicator::VisLogSync' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, RenderingComp) == 0x000300, "Member 'AGameplayDebuggerCategoryReplicator::RenderingComp' has a wrong offset!");
...
public:
	...
	static class UGameplayDebuggerConfig* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGameplayDebuggerUserSettings* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UGameplayDebuggerLocalController* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	TArray<class AGameplayDebuggerCategoryReplicator*> PendingRegistrations;                         // 0x02C8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	static class AGameplayDebuggerPlayerManager* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(AGameplayDebuggerPlayerManager) == 0x0002E0, "Wrong size on AGameplayDebuggerPlayerManager");
static_assert(offsetof(AGameplayDebuggerPlayerManager, PlayerData) == 0x0002B8, "Member 'AGameplayDebuggerPlayerManager::PlayerData' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerPlayerManager, PendingRegistrations) == 0x0002C8, "Member 'AGameplayDebuggerPlayerManager::PendingRegistrations' has a wrong offset!");
...
{
public:
	uint8                                         Pad_600[0x60];                                     // 0x0600(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static class UGameplayDebuggerRenderingComponent* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UGameplayDebuggerRenderingComponent) == 0x000660, "Wrong size on UGameplayDebuggerRenderingComponent");

...
// Enum AkAudio.EAkRoomMaterial
// NumValues: 0x0004
enum class EAkRoomMaterial : uint8
{
	Concrete                                 = 0,
	Metal                                    = 1,
	Wood                                     = 2,
	EAkRoomMaterial_MAX                      = 3,
};
...
// ScriptStruct AkAudio.AkRoomType
// 0x0020 (0x0020 - 0x0000)
struct FAkRoomType final
{
public:
	EAkRoomMaterial                               Material;                                          // 0x0000(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFloatRange                            SizeRange;                                         // 0x0004(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkAuxBus*                              AuxBus;                                            // 0x0018(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAkRoomType) == 0x000008, "Wrong alignment on FAkRoomType");
static_assert(sizeof(FAkRoomType) == 0x000020, "Wrong size on FAkRoomType");
static_assert(offsetof(FAkRoomType, Material) == 0x000000, "Member 'FAkRoomType::Material' has a wrong offset!");
static_assert(offsetof(FAkRoomType, SizeRange) == 0x000004, "Member 'FAkRoomType::SizeRange' has a wrong offset!");
static_assert(offsetof(FAkRoomType, AuxBus) == 0x000018, "Member 'FAkRoomType::AuxBus' has a wrong offset!");

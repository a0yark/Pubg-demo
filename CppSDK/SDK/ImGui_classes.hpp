...
public:
	...
	static class UImGuiInputHandler* GetDefaultObj()	 // 0x0
	{
...
static_assert(sizeof(UImGuiInputHandler) == 0x000058, "Wrong size on UImGuiInputHandler");
...
public:
	...
	static class UImGuiSettings* GetDefaultObj()	 // 0x0
	{
...
// Class ImGui.NetImGuiSettings
// 0x0008 (0x0030 - 0x0028)
class UNetImGuiSettings final : public UObject
{
public:
	int32                                         ResolutionX;                                       // 0x0028(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ResolutionY;                                       // 0x002C(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()	 // 0x0
	{
		return StaticClassImpl<"NetImGuiSettings">();
	}
	static class UNetImGuiSettings* GetDefaultObj()	 // 0x0
	{
		return GetDefaultObjImpl<UNetImGuiSettings>();
	}
};
static_assert(alignof(UNetImGuiSettings) == 0x000008, "Wrong alignment on UNetImGuiSettings");
static_assert(sizeof(UNetImGuiSettings) == 0x000030, "Wrong size on UNetImGuiSettings");
static_assert(offsetof(UNetImGuiSettings, ResolutionX) == 0x000028, "Member 'UNetImGuiSettings::ResolutionX' has a wrong offset!");
static_assert(offsetof(UNetImGuiSettings, ResolutionY) == 0x00002C, "Member 'UNetImGuiSettings::ResolutionY' has a wrong offset!");

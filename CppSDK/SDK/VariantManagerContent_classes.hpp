...
public:
	int32 GetNumVariantSets()	 // 0x46db7e8;
	class UVariantSet* GetVariantSet(int32 VariantSetIndex)	 // 0x518d0e4;
	class UVariantSet* GetVariantSetByName(const class FString& VariantSetName)	 // 0x518d1c4;
...
public:
	...
	static class ULevelVariantSets* GetDefaultObj()	 // 0x0
	{
...
public:
	class ULevelVariantSets* GetLevelVariantSets(bool bLoad)	 // 0x518cd20;
	void SetLevelVariantSets(class ULevelVariantSets* InVariantSets)	 // 0x518d688;
	bool SwitchOnVariantByIndex(int32 VariantSetIndex, int32 VariantIndex)	 // 0x518e11c;
	bool SwitchOnVariantByName(const class FString& VariantSetName, const class FString& VariantName)	 // 0x518e2a8;
...
public:
	...
	static class ALevelVariantSetsActor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULevelVariantSetsFunctionDirector* GetDefaultObj()	 // 0x0
	{
...
public:
	class FString GetFullDisplayString() const	 // 0x518cd04;
	class FText GetPropertyTooltip() const	 // 0x518ce8c;
	bool HasRecordedData() const	 // 0x518d2b0;
...
public:
	...
	static class UPropertyValue* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPropertyValueTransform* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPropertyValueVisibility* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPropertyValueColor* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPropertyValueMaterial* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPropertyValueOption* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPropertyValueSoftObject* GetDefaultObj()	 // 0x0
	{
...
public:
	void SelectOption(int32 OptionIndex)	 // 0x518d35c;

	TArray<class AActor*> GetOptions() const	 // 0x518ce04;
	int32 GetSelectedOption() const	 // 0x518cee8;
...
public:
	...
	static class ASwitchActor* GetDefaultObj()	 // 0x0
	{
...
public:
	int32 AddDependency(struct FVariantDependency* Dependency)	 // 0x518c688;
	void DeleteDependency(int32 Index_0)	 // 0x518c738;
	class AActor* GetActor(int32 ActorIndex)	 // 0x518c7f8;
	struct FVariantDependency GetDependency(int32 Index_0)	 // 0x518c8f0;
	TArray<class UVariant*> GetDependents(class ULevelVariantSets* LevelVariantSets, bool bOnlyEnabledDependencies)	 // 0x518c9c4;
	int32 GetNumActors()	 // 0x518cdf0;
	int32 GetNumDependencies()	 // 0x4f992f4;
	class UVariantSet* GetParent()	 // 0x518ce44;
	class UTexture2D* GetThumbnail()	 // 0x518cf00;
	bool IsActive()	 // 0x518d2c8;
	void SetDependency(int32 Index_0, struct FVariantDependency* Dependency)	 // 0x518d41c;
	void SetDisplayText(const class FText& NewDisplayText)	 // 0x518d550;
	void SetThumbnailFromCamera(class UObject* WorldContextObject, const struct FTransform& CameraTransform, float FOVDegrees, float MinZ, float Gamma)	 // 0x518d748;
	void SetThumbnailFromEditorViewport()	 // 0x17c7f2c;
	void SetThumbnailFromFile(const class FString& FilePath)	 // 0x518dd58;
	void SetThumbnailFromTexture(class UTexture2D* NewThumbnail)	 // 0x518df68;
	void SwitchOn()	 // 0x518e108;

	class FText GetDisplayText() const	 // 0x518cc64;
...
public:
	...
	static class UVariant* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UVariantObjectBinding* GetDefaultObj()	 // 0x0
	{
...
public:
	class ULevelVariantSets* GetParent()	 // 0x518ce68;
	class UTexture2D* GetThumbnail()	 // 0x4f7eb08;
	class UVariant* GetVariant(int32 VariantIndex)	 // 0x518cf18;
	class UVariant* GetVariantByName(const class FString& VariantName)	 // 0x518cff8;
	void SetDisplayText(const class FText& NewDisplayText)	 // 0x518d5ec;
	void SetThumbnailFromCamera(class UObject* WorldContextObject, const struct FTransform& CameraTransform, float FOVDegrees, float MinZ, float Gamma)	 // 0x518da50;
	void SetThumbnailFromEditorViewport()	 // 0x17c7f2c;
	void SetThumbnailFromFile(const class FString& FilePath)	 // 0x518de60;
	void SetThumbnailFromTexture(class UTexture2D* NewThumbnail)	 // 0x518e038;

	class FText GetDisplayText() const	 // 0x518ccb4;
	int32 GetNumVariants() const	 // 0x3fc0154;
...
public:
	...
	static class UVariantSet* GetDefaultObj()	 // 0x0
	{

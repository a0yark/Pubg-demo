...
{
public:
	struct FCameraAnimationHandle PlayCameraAnimation(class APlayerController* PlayerController, class UCameraAnimationSequence* Sequence, const struct FCameraAnimationParams& Params_0)	 // 0x514eba0;
	void StopAllCameraAnimations(class APlayerController* PlayerController, bool bImmediate)	 // 0x514f584;
	void StopAllCameraAnimationsOf(class APlayerController* PlayerController, class UCameraAnimationSequence* Sequence, bool bImmediate)	 // 0x514f814;
	void StopCameraAnimation(class APlayerController* PlayerController, const struct FCameraAnimationHandle& Handle, bool bImmediate)	 // 0x514fb64;

	bool IsCameraAnimationActive(class APlayerController* PlayerController, const struct FCameraAnimationHandle& Handle) const	 // 0x514e778;
...
public:
	...
	static class UGameplayCamerasSubsystem* GetDefaultObj()	 // 0x0
	{
...
public:
	static class ULegacyCameraShake* StartLegacyCameraShake(class APlayerCameraManager* PlayerCameraManager, TSubclassOf<class ULegacyCameraShake> ShakeClass, float Scale, ECameraShakePlaySpace PlaySpace, const struct FRotator& UserPlaySpaceRot)	 // 0x514ef2c;
	static class ULegacyCameraShake* StartLegacyCameraShakeFromSource(class APlayerCameraManager* PlayerCameraManager, TSubclassOf<class ULegacyCameraShake> ShakeClass, class UCameraShakeSourceComponent* SourceComponent, float Scale, ECameraShakePlaySpace PlaySpace, const struct FRotator& UserPlaySpaceRot)	 // 0x514f214;

	void BlueprintUpdateCameraShake(float DeltaTime, float ALPHA, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)	 // 0xae1e64;
	void ReceivePlayShake(float Scale)	 // 0xae1e64;
	void ReceiveStopShake(bool bImmediately)	 // 0xae1e64;

	bool ReceiveIsFinished() const	 // 0x15fac24;
...
public:
	...
	static class ULegacyCameraShake* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class ULegacyCameraShakePattern* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static class ULegacyCameraShake* Conv_LegacyCameraShake(class UCameraShakeBase* CameraShake)	 // 0x514e2d0;
...
public:
	...
	static class ULegacyCameraShakeFunctionLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	static class UCameraAnimationCameraModifier* GetCameraAnimationCameraModifier(const class UObject* WorldContextObject, int32 PlayerIndex)	 // 0x514e38c;
	static class UCameraAnimationCameraModifier* GetCameraAnimationCameraModifierFromID(const class UObject* WorldContextObject, int32 ControllerId)	 // 0x514e4d4;
	static class UCameraAnimationCameraModifier* GetCameraAnimationCameraModifierFromPlayerController(const class APlayerController* PlayerController)	 // 0x514e61c;

	struct FCameraAnimationHandle PlayCameraAnimation(class UCameraAnimationSequence* Sequence, const struct FCameraAnimationParams& Params_0)	 // 0x514e89c;
	void StopAllCameraAnimations(bool bImmediate)	 // 0x4bb0c5c;
	void StopAllCameraAnimationsOf(class UCameraAnimationSequence* Sequence, bool bImmediate)	 // 0x514f6d4;
	void StopCameraAnimation(const struct FCameraAnimationHandle& Handle, bool bImmediate)	 // 0x514f9e0;

	bool IsCameraAnimationActive(const struct FCameraAnimationHandle& Handle) const	 // 0x514e6dc;
...
public:
	...
	static class UCameraAnimationCameraModifier* GetDefaultObj()	 // 0x0
	{
...
{
public:
	static class UCameraAnimationCameraModifier* Conv_CameraAnimationCameraModifier(class APlayerCameraManager* PlayerCameraManager)	 // 0x514e110;
	static ECameraAnimationPlaySpace Conv_CameraAnimationPlaySpace(ECameraShakePlaySpace CameraShakePlaySpace)	 // 0x514e204;
	static ECameraShakePlaySpace Conv_CameraShakePlaySpace(ECameraAnimationPlaySpace CameraAnimationPlaySpace)	 // 0x514e204;
...
public:
	...
	static class UGameplayCamerasFunctionLibrary* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UCompositeCameraShakePattern* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UDefaultCameraShakeBase* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class USimpleCameraShakePattern* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UPerlinNoiseCameraShakePattern* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UTestCameraShake* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UConstantCameraShakePattern* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UWaveOscillatorCameraShakePattern* GetDefaultObj()	 // 0x0
	{

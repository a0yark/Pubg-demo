...
public:
	class UMediaCapture* CreateMediaCapture()	 // 0x4f7169c;

	bool Validate(class FString* OutFailureReason) const	 // 0x4f71944;
...
public:
	...
	static class UMediaOutput* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UFileMediaOutput* GetDefaultObj()	 // 0x0
	{
...
public:
	bool CaptureActiveSceneViewport(const struct FMediaCaptureOptions& CaptureOptions)	 // 0x4f71434;
	bool CaptureTextureRenderTarget2D(class UTextureRenderTarget2D* RenderTarget, const struct FMediaCaptureOptions& CaptureOptions)	 // 0x4f71528;
	void SetMediaOutput(class UMediaOutput* InMediaOutput)	 // 0x4f716f0;
	void StopCapture(bool bAllowPendingFrameToBeProcess)	 // 0x4f717b0;
	bool UpdateTextureRenderTarget2D(class UTextureRenderTarget2D* RenderTarget)	 // 0x4f71874;

	EPixelFormat GetDesiredPixelFormat() const	 // 0x4f716c0;
	struct FIntPoint GetDesiredSize() const	 // 0x4f716d8;
	EMediaCaptureState GetState() const	 // 0x15fac24;
...
public:
	...
	static class UMediaCapture* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UFileMediaCapture* GetDefaultObj()	 // 0x0
	{
...
public:
	...
	static class UMediaIOCoreSubsystem* GetDefaultObj()	 // 0x0
	{
